...
public class e<K, V> {
    ...
    public final V c(K r5) {
        /*
            ...
            int r5 = r4.f8476g     // Catch:{ all -> 0x0051 }
            int r5 = r5 + 1
            r4.f8476g = r5     // Catch:{ all -> 0x0051 }
            monitor-exit(r4)     // Catch:{ all -> 0x0051 }
            return r0
        L_0x0013:
            int r0 = r4.f8477h     // Catch:{ all -> 0x0051 }
            int r0 = r0 + 1
            r4.f8477h = r0     // Catch:{ all -> 0x0051 }
            monitor-exit(r4)     // Catch:{ all -> 0x0051 }
        ...
        L_0x0022:
            monitor-enter(r4)
            int r1 = r4.f8474e     // Catch:{ all -> 0x004e }
            int r1 = r1 + 1
            r4.f8474e = r1     // Catch:{ all -> 0x004e }
        ...
        L_0x0037:
            ...
            int r3 = r4.e(r5, r0)     // Catch:{ all -> 0x004e }
            int r2 = r2 + r3
        ...
        L_0x0054:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: e.e.e.c(java.lang.Object):java.lang.Object");
    }
    ...
    public void h(int r5) {
        ...
        L_0x001e:
            ...
            int r3 = r4.e(r1, r0)     // Catch:{ all -> 0x0071 }
            int r2 = r2 - r3
            r4.b = r2     // Catch:{ all -> 0x0071 }
            int r2 = r4.f8475f     // Catch:{ all -> 0x0071 }
            r3 = 1
            int r2 = r2 + r3
            r4.f8475f = r2     // Catch:{ all -> 0x0071 }
        ...
        L_0x0071:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: e.e.e.h(int):void");
    }

    public final synchronized String toString() {
        int i2;
        i2 = this.f8476g + this.f8477h;
        return String.format(Locale.US, "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", new Object[]{Integer.valueOf(this.c), Integer.valueOf(this.f8476g), Integer.valueOf(this.f8477h), Integer.valueOf(i2 != 0 ? (this.f8476g * 100) / i2 : 0)});
    }
}
