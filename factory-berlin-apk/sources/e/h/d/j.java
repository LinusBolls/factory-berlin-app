...
class j {
    ...
    /* compiled from: TypefaceCompatBaseImpl */
    class b implements c<c.C0014c> {
        b(j jVar) {
        }

        /* renamed from: c */
        public int a(c.C0014c cVar) {
            return cVar.e();
        }

        /* renamed from: d */
        public boolean b(c.C0014c cVar) {
            return cVar.f();
        }
    }
    ...
    private c.C0014c f(c.b bVar, int i2) {
        return (c.C0014c) g(bVar.a(), i2, new b(this));
    }
