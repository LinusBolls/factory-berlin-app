...
public final class a {
    ...
    private static final WeakHashMap<Context, SparseArray<C0550a>> b = new WeakHashMap<>(0);
    ...
    private static class C0550a {
        ...
        C0550a(ColorStateList colorStateList, Configuration configuration) {
    ...
    private static void a(Context context, int i2, ColorStateList colorStateList) {
        synchronized (c) {
            ...
            sparseArray.append(i2, new C0550a(colorStateList, context.getResources().getConfiguration()));
        }
    }
    ...
    private static android.content.res.ColorStateList b(android.content.Context r4, int r5) {
        /*
            ...
            e.a.k.a.a$a r2 = (e.a.k.a.a.C0550a) r2     // Catch:{ all -> 0x0035 }
            if (r2 == 0) goto L_0x0032
