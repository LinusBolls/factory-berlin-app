...
public class f extends ActionMode {
    ...
    public static class a implements b.a {
        ...
        final g<Menu, Menu> f8394d = new g<>();
        ...
        private Menu f(Menu menu) {
            Menu menu2 = this.f8394d.get(menu);
            if (menu2 != null) {
                return menu2;
            }
            o oVar = new o(this.b, (e.h.e.a.a) menu);
            this.f8394d.put(menu, oVar);
            return oVar;
        }
        ...
        public boolean c(b bVar, MenuItem menuItem) {
            return this.a.onActionItemClicked(e(bVar), new j(this.b, (e.h.e.a.b) menuItem));
        }
    ...
    public Menu getMenu() {
        return new o(this.a, (e.h.e.a.a) this.b.e());
    }
