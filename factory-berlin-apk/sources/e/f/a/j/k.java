...
public class k {
    ...
    static void a(int i2, f fVar) {
        ...
        if (!(f2.f8608h == 4 || f4.f8608h == 4)) {
            if (fVar2.C[0] == f.b.FIXED || (z2 && fVar.C() == 8)) {
                if (fVar2.s.f8559d == null && fVar2.u.f8559d == null) {
                    f2.p(1);
                    f4.p(1);
                    if (z) {
                        f4.j(f2, 1, fVar.x());
                ...
                } else if (fVar2.s.f8559d != null && fVar2.u.f8559d == null) {
                    f2.p(1);
                    f4.p(1);
                    if (z) {
                        f4.j(f2, 1, fVar.x());
        ...
        if (f3.f8608h != 4 && f5.f8608h != 4) {
            if (fVar2.C[1] == f.b.FIXED || (z3 && fVar.C() == 8)) {
                if (fVar2.t.f8559d == null && fVar2.v.f8559d == null) {
                    f3.p(1);
                    f5.p(1);
                    if (z) {
                        f5.j(f3, 1, fVar.w());
                ...
                } else if (fVar2.t.f8559d != null && fVar2.v.f8559d == null) {
                    f3.p(1);
                    f5.p(1);
                    if (z) {
                        f5.j(f3, 1, fVar.w());
    ...
    static boolean b(e.f.a.j.g r24, e.f.a.e r25, int r26, int r27, e.f.a.j.d r28) {
        /*
            r0 = r25
            r1 = r26
            r2 = r28
            ...
            e.f.a.j.f r4 = r2.c
            e.f.a.j.f r5 = r2.b
            e.f.a.j.f r6 = r2.f8548d
            e.f.a.j.f r7 = r2.f8549e
            float r8 = r2.f8555k
            e.f.a.j.f r9 = r2.f8550f
            e.f.a.j.f r2 = r2.f8551g
            r9 = r24
            e.f.a.j.f$b[] r2 = r9.C
            r2 = r2[r1]
            e.f.a.j.f$b r9 = e.f.a.j.f.b.WRAP_CONTENT
            r2 = 2
            r10 = 1
        ...
        L_0x010a:
            ...
            r13 = r13[r19]
            e.f.a.j.l r13 = r13.f()
            e.f.a.j.l r7 = r9.f8604d
            if (r7 == 0) goto L_0x0385
            r21 = r3
            e.f.a.j.l r3 = r13.f8604d
        ...
        L_0x014f:
            ...
            float r0 = r0 + r3
        L_0x015b:
            e.f.a.j.l r3 = r9.f8604d
            float r3 = r3.f8607g
            e.f.a.j.l r6 = r13.f8604d
            float r6 = r6.f8607g
        ...
        L_0x016b:
            ...
            e.f.a.j.f$b[] r0 = r0.C
            r0 = r0[r1]
            e.f.a.j.f$b r2 = e.f.a.j.f.b.WRAP_CONTENT
        ...
        L_0x0385:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: e.f.a.j.k.b(e.f.a.j.g, e.f.a.e, int, int, e.f.a.j.d):boolean");
    }

    static void c(g gVar, e eVar, f fVar) {
        if (gVar.C[0] != f.b.WRAP_CONTENT && fVar.C[0] == f.b.MATCH_PARENT) {
            int i2 = fVar.s.f8560e;
            int D = gVar.D() - fVar.u.f8560e;
            e eVar2 = fVar.s;
            eVar2.f8564i = eVar.r(eVar2);
            e eVar3 = fVar.u;
            eVar3.f8564i = eVar.r(eVar3);
            eVar.f(fVar.s.f8564i, i2);
            eVar.f(fVar.u.f8564i, D);
            fVar.a = 2;
            fVar.f0(i2, D);
        }
        if (gVar.C[1] != f.b.WRAP_CONTENT && fVar.C[1] == f.b.MATCH_PARENT) {
            int i3 = fVar.t.f8560e;
            int r = gVar.r() - fVar.v.f8560e;
            e eVar4 = fVar.t;
            eVar4.f8564i = eVar.r(eVar4);
            e eVar5 = fVar.v;
            eVar5.f8564i = eVar.r(eVar5);
            eVar.f(fVar.t.f8564i, i3);
            eVar.f(fVar.v.f8564i, r);
            if (fVar.Q > 0 || fVar.C() == 8) {
                e eVar6 = fVar.w;
                eVar6.f8564i = eVar.r(eVar6);
                eVar.f(fVar.w.f8564i, fVar.Q + i3);
            }
            fVar.b = 2;
            fVar.t0(i3, r);
        }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static boolean d(e.f.a.j.f r5, int r6) {
        /*
            e.f.a.j.f$b[] r0 = r5.C
            r1 = r0[r6]
            e.f.a.j.f$b r2 = e.f.a.j.f.b.MATCH_CONSTRAINT
            r3 = 0
        ...
        L_0x0016:
            r5 = r0[r4]
            e.f.a.j.f$b r6 = e.f.a.j.f.b.MATCH_CONSTRAINT
        ...
        L_0x003c:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: e.f.a.j.k.d(e.f.a.j.f, int):boolean");
    }

    static void e(f fVar, int i2, int i3) {
        int i4 = i2 * 2;
        int i5 = i4 + 1;
        fVar.A[i4].f().f8606f = fVar.u().s.f();
        fVar.A[i4].f().f8607g = (float) i3;
        fVar.A[i4].f().b = 1;
        fVar.A[i5].f().f8606f = fVar.A[i4].f();
        fVar.A[i5].f().f8607g = (float) fVar.t(i2);
        fVar.A[i5].f().b = 1;
    }
}
