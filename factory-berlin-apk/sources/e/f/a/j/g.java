...
public class g extends p {
    ...
    public void K0() {
        ...
        L_0x006e:
            ...
            r11 = r0[r4]
            r21.b1()
            java.util.List<e.f.a.j.h> r0 = r1.w0
            int r0 = r0.size()
            if (r0 != 0) goto L_0x0090
            java.util.List<e.f.a.j.h> r0 = r1.w0
            r0.clear()
            java.util.List<e.f.a.j.h> r0 = r1.w0
            e.f.a.j.h r12 = new e.f.a.j.h
            java.util.ArrayList<e.f.a.j.f> r13 = r1.k0
            r12.<init>(r13)
            r0.add(r4, r12)
        L_0x0090:
            java.util.List<e.f.a.j.h> r0 = r1.w0
            int r12 = r0.size()
            java.util.ArrayList<e.f.a.j.f> r13 = r1.k0
            e.f.a.j.f$b r0 = r21.s()
            e.f.a.j.f$b r14 = e.f.a.j.f.b.WRAP_CONTENT
            if (r0 == r14) goto L_0x00ab
            e.f.a.j.f$b r0 = r21.B()
            e.f.a.j.f$b r14 = e.f.a.j.f.b.WRAP_CONTENT
        ...
        L_0x00ae:
            ...
            java.util.List<e.f.a.j.h> r8 = r1.w0
            java.lang.Object r8 = r8.get(r15)
            e.f.a.j.h r8 = (e.f.a.j.h) r8
            boolean r8 = r8.f8596d
        ...
        L_0x00c4:
            ...
            e.f.a.j.f$b r8 = r21.s()
            e.f.a.j.f$b r7 = e.f.a.j.f.b.FIXED
            if (r8 != r7) goto L_0x00eb
            e.f.a.j.f$b r7 = r21.B()
            e.f.a.j.f$b r8 = e.f.a.j.f.b.FIXED
            if (r7 != r8) goto L_0x00eb
            java.util.List<e.f.a.j.h> r7 = r1.w0
            java.lang.Object r7 = r7.get(r15)
            e.f.a.j.h r7 = (e.f.a.j.h) r7
        ...
        L_0x00eb:
            ...
            java.lang.Object r7 = r7.get(r15)
            e.f.a.j.h r7 = (e.f.a.j.h) r7
            java.util.List<e.f.a.j.f> r7 = r7.a
            java.util.ArrayList r7 = (java.util.ArrayList) r7
            r1.k0 = r7
        L_0x00f9:
            r21.b1()
            java.util.ArrayList<e.f.a.j.f> r7 = r1.k0
            int r7 = r7.size()
            r8 = 0
        L_0x0103:
            if (r8 >= r7) goto L_0x011b
            java.util.ArrayList<e.f.a.j.f> r4 = r1.k0
            java.lang.Object r4 = r4.get(r8)
            e.f.a.j.f r4 = (e.f.a.j.f) r4
            boolean r9 = r4 instanceof e.f.a.j.p
            if (r9 == 0) goto L_0x0116
            e.f.a.j.p r4 = (e.f.a.j.p) r4
            r4.K0()
        L_0x0116:
            int r8 = r8 + 1
            r4 = 0
        ...
        L_0x011e:
            ...
            r9 = 1
            int r4 = r0 + 1
            e.f.a.e r0 = r1.m0     // Catch:{ Exception -> 0x0162 }
        ...
        L_0x0133:
            ...
            java.util.ArrayList<e.f.a.j.f> r9 = r1.k0     // Catch:{ Exception -> 0x0162 }
            java.lang.Object r9 = r9.get(r0)     // Catch:{ Exception -> 0x0162 }
            e.f.a.j.f r9 = (e.f.a.j.f) r9     // Catch:{ Exception -> 0x0162 }
            r18 = r8
            e.f.a.e r8 = r1.m0     // Catch:{ Exception -> 0x015e }
        ...
        L_0x0149:
            r18 = r8
            e.f.a.e r0 = r1.m0     // Catch:{ Exception -> 0x015e }
            boolean r8 = r1.O0(r0)     // Catch:{ Exception -> 0x015e }
            if (r8 == 0) goto L_0x015b
            e.f.a.e r0 = r1.m0     // Catch:{ Exception -> 0x0159 }
        ...
        L_0x0195:
            ...
            java.util.ArrayList<e.f.a.j.f> r9 = r1.k0
            java.lang.Object r9 = r9.get(r8)
            e.f.a.j.f r9 = (e.f.a.j.f) r9
            e.f.a.j.f$b[] r12 = r9.C
            r16 = 0
            r12 = r12[r16]
            e.f.a.j.f$b r0 = e.f.a.j.f.b.MATCH_CONSTRAINT
            if (r12 != r0) goto L_0x01ba
            int r0 = r9.D()
            int r12 = r9.F()
            if (r0 >= r12) goto L_0x01ba
            boolean[] r0 = e.f.a.j.k.a
            r8 = 2
            r12 = 1
            r0[r8] = r12
            goto L_0x018d
        L_0x01ba:
            ...
            e.f.a.j.f$b[] r0 = r9.C
            r0 = r0[r12]
            e.f.a.j.f$b r12 = e.f.a.j.f.b.MATCH_CONSTRAINT
        ...
        L_0x01e7:
            ...
            java.util.ArrayList<e.f.a.j.f> r8 = r1.k0
            java.lang.Object r8 = r8.get(r0)
            e.f.a.j.f r8 = (e.f.a.j.f) r8
            r18 = r4
            int r4 = r8.I
            int r20 = r8.D()
            int r4 = r4 + r20
        ...
        L_0x0211:
            ...
            e.f.a.j.f$b r8 = e.f.a.j.f.b.WRAP_CONTENT
        ...
        L_0x0238:
            ...
            r1.b0(r4)
            e.f.a.j.f$b[] r0 = r1.C
            e.f.a.j.f$b r4 = e.f.a.j.f.b.WRAP_CONTENT
            r8 = 1
            r0[r8] = r4
            r0 = 1
            r17 = 1
        ...
        L_0x0253:
            ...
            r1.y0(r4)
            e.f.a.j.f$b[] r0 = r1.C
            e.f.a.j.f$b r4 = e.f.a.j.f.b.FIXED
            r8 = 0
            r0[r8] = r4
            r0 = 1
            r17 = 1
        ...
        L_0x0290:
            ...
            r12 = 0
            r4 = r4[r12]
            e.f.a.j.f$b r12 = e.f.a.j.f.b.WRAP_CONTENT
        ...
        L_0x0346:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: e.f.a.j.g.K0():void");
    }
    ...
    public void Y0(int i2, int i3) {
        m mVar;
        m mVar2;
        if (!(this.C[0] == f.b.WRAP_CONTENT || (mVar2 = this.c) == null)) {
            mVar2.h(i2);
        }
        if (this.C[1] != f.b.WRAP_CONTENT && (mVar = this.f8580d) != null) {
            mVar.h(i3);
        }
    }
    ...
    public void f1(e.f.a.e eVar, boolean[] zArr) {
        zArr[2] = false;
        G0(eVar);
        int size = this.k0.size();
        for (int i2 = 0; i2 < size; i2++) {
