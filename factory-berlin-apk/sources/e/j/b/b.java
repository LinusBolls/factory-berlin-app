...
class b {
    ...
    private static class c<T> implements Comparator<T> {
        ...
        private final Rect f8735g = new Rect();

        /* renamed from: h  reason: collision with root package name */
        private final Rect f8736h = new Rect();

        /* renamed from: i  reason: collision with root package name */
        private final boolean f8737i;

        /* renamed from: j  reason: collision with root package name */
        private final a<T> f8738j;
        ...
        public int compare(T t, T t2) {
            ...
            Rect rect2 = this.f8736h;
            this.f8738j.a(t, rect);
            this.f8738j.a(t2, rect2);
            int i2 = rect.top;
            int i3 = rect2.top;
            if (i2 < i3) {
                return -1;
    ...
    public static <L, T> T c(L l2, C0569b<L, T> bVar, a<T> aVar, T t, Rect rect, int i2) {
    ...
    public static <L, T> T d(L l2, C0569b<L, T> bVar, a<T> aVar, T t, int i2, boolean z, boolean z2) {
        int b = bVar.b(l2);
