...
public final class c extends h {
    ...
    private final ConcurrentNavigableMap<String, a> f11760d = new ConcurrentSkipListMap();
    ...
    private boolean h(InputStream inputStream) {
        ...
        for (a next : i(inputStream)) {
            a aVar = (a) this.f11760d.putIfAbsent(next.a, next);
            if (aVar == null || aVar.a.equals(next.a)) {
                z = true;
            } else {
                throw new ZoneRulesException("Data already loaded for TZDB time-zone rules version: " + next.a);
            }
        }
        return z;
    }
    ...
    private java.lang.Iterable<org.threeten.bp.zone.c.a> i(java.io.InputStream r13) {
        /*
            r12 = this;
        ...
        L_0x0072:
            ...
            goto L_0x0072
        L_0x0085:
            org.threeten.bp.zone.c$a r7 = new org.threeten.bp.zone.c$a
            r10 = r1[r6]
        ...
        L_0x0099:
            ...
            throw r13
        */
        throw new UnsupportedOperationException("Method not decompiled: org.threeten.bp.zone.c.i(java.io.InputStream):java.lang.Iterable");
    }

    /* access modifiers changed from: protected */
    public f d(String str, boolean z) {
        d.i(str, "zoneId");
        f c2 = ((a) this.f11760d.lastEntry().getValue()).c(str);
        if (c2 != null) {
            return c2;
        }
