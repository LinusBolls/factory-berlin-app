    ...
    public JsonSerializer<Object> constructBeanSerializer(SerializerProvider serializerProvider, BeanDescription beanDescription) {
        ...
        if (this._factoryConfig.hasSerializerModifiers()) {
            for (BeanSerializerModifier changeProperties : this._factoryConfig.serializerModifiers()) {
                changeProperties.changeProperties(config, beanDescription, findBeanProperties);
            }
        }
        ...
        if (this._factoryConfig.hasSerializerModifiers()) {
            for (BeanSerializerModifier orderProperties : this._factoryConfig.serializerModifiers()) {
                orderProperties.orderProperties(config, beanDescription, findBeanProperties);
            }
        }
        ...
        if (this._factoryConfig.hasSerializerModifiers()) {
            for (BeanSerializerModifier updateBuilder : this._factoryConfig.serializerModifiers()) {
                updateBuilder.updateBuilder(config, beanDescription, constructBeanSerializerBuilder);
            }
        }
        try {
