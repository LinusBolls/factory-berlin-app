...
public class BeanAsArraySerializer extends BeanSerializerBase {
    ...
    public final void serializeAsArray(Object obj, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) {
        ...
        try {
            ...
            wrapAndThrow(serializerProvider, (Throwable) e2, obj, str);
            throw null;
        } catch (StackOverflowError e3) {
            JsonMappingException from = JsonMappingException.from(jsonGenerator, "Infinite recursion (StackOverflowError)", (Throwable) e3);
            if (0 != beanPropertyWriterArr.length) {
                str = beanPropertyWriterArr[0].getName();
            }
