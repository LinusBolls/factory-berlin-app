...
public final class TypeFactory implements Serializable {
    ...
    private String _resolveTypePlaceholders(JavaType javaType, JavaType javaType2) {
        ...
        while (i2 < size) {
            ...
            if (_verifyAndResolvePlaceholders(javaType3, javaType4) || javaType3.hasRawClass(cls) || ((i2 == 0 && javaType.hasRawClass(Map.class) && javaType4.hasRawClass(cls)) || (javaType3.isInterface() && javaType3.isTypeOrSuperTypeOf(javaType4.getRawClass())))) {
                i2++;
            } else {
                return String.format("Type parameter #%d/%d differs; can not specialize %s with %s", new Object[]{Integer.valueOf(i2 + 1), Integer.valueOf(size), javaType3.toCanonical(), javaType4.toCanonical()});
            }
        }
        return null;
    }
