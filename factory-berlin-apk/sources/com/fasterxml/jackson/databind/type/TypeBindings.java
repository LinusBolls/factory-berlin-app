...
public class TypeBindings implements Serializable {
    ...
    public static TypeBindings createIfNeeded(Class<?> cls, JavaType javaType) {
        ...
        throw new IllegalArgumentException("Cannot create TypeBindings for class " + cls.getName() + " with 1 type parameter: class expects " + i2);
    }
    ...
    public static TypeBindings create(Class<?> cls, JavaType javaType, JavaType javaType2) {
        ...
        if (paramsFor2 == null) {
            ...
            i2 = paramsFor2.length;
        }
        if (i2 == 2) {
            return new TypeBindings(new String[]{paramsFor2[0].getName(), paramsFor2[1].getName()}, new JavaType[]{javaType, javaType2}, (String[]) null);
        }
        throw new IllegalArgumentException("Cannot create TypeBindings for class " + cls.getName() + " with 2 type parameters: class expects " + i2);
    }
}
