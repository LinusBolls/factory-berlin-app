...
public class JacksonAnnotationIntrospector extends AnnotationIntrospector implements Serializable {
    ...
    private JsonInclude.Value _refinePropertyInclusion(Annotated annotated, JsonInclude.Value value) {
        ...
        if (jsonSerialize != null) {
            int i2 = AnonymousClass1.$SwitchMap$com$fasterxml$jackson$databind$annotation$JsonSerialize$Inclusion[jsonSerialize.include().ordinal()];
            if (i2 == 1) {
    ...
    public JavaType refineDeserializationType(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) {
        ...
        if (cls != null && !javaType.hasRawClass(cls) && !_primitiveAndWrapper(javaType, cls)) {
            try {
                ...
                throw new JsonMappingException((Closeable) null, String.format("Failed to narrow type %s with annotation (value %s), from '%s': %s", new Object[]{javaType, cls.getName(), annotated.getName(), e2.getMessage()}), (Throwable) e2);
            }
        }
        if (javaType.isMapLikeType()) {
            ...
            if (cls3 != null && !_primitiveAndWrapper(keyType, cls3)) {
                try {
                    ...
                    throw new JsonMappingException((Closeable) null, String.format("Failed to narrow key type of %s with concrete-type annotation (value %s), from '%s': %s", new Object[]{javaType, cls3.getName(), annotated.getName(), e3.getMessage()}), (Throwable) e3);
                }
            }
        }
        ...
        try {
            ...
            throw new JsonMappingException((Closeable) null, String.format("Failed to narrow value type of %s with concrete-type annotation (value %s), from '%s': %s", new Object[]{javaType, cls2.getName(), annotated.getName(), e4.getMessage()}), (Throwable) e4);
        }
    }
    ...
    public JavaType refineSerializationType(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) {
        ...
        if (cls != null) {
            if (javaType.hasRawClass(cls)) {
                ...
                try {
                    ...
                    throw new JsonMappingException((Closeable) null, String.format("Failed to widen type %s with annotation (value %s), from '%s': %s", new Object[]{javaType, cls.getName(), annotated.getName(), e2.getMessage()}), (Throwable) e2);
                }
            }
        }
        if (javaType.isMapLikeType()) {
            ...
            if (cls3 != null) {
                if (keyType.hasRawClass(cls3)) {
                    ...
                    try {
                        ...
                        throw new JsonMappingException((Closeable) null, String.format("Failed to widen key type of %s with concrete-type annotation (value %s), from '%s': %s", new Object[]{javaType, cls3.getName(), annotated.getName(), e3.getMessage()}), (Throwable) e3);
                    }
                }
        ...
        if (contentType.hasRawClass(cls2)) {
            ...
            try {
                ...
                throw new JsonMappingException((Closeable) null, String.format("Internal error: failed to refine value type of %s with concrete-type annotation (value %s), from '%s': %s", new Object[]{javaType, cls2.getName(), annotated.getName(), e4.getMessage()}), (Throwable) e4);
            }
        }
