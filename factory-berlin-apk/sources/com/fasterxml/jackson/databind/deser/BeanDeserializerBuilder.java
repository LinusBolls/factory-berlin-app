...
public class BeanDeserializerBuilder {
    ...
    public JsonDeserializer<?> buildBuilderBased(JavaType javaType, String str) {
        ...
        z = z2;
        return new BuilderBasedDeserializer(this, this._beanDesc, javaType, this._objectIdReader != null ? construct.withProperty(new ObjectIdValueProperty(this._objectIdReader, PropertyMetadata.STD_REQUIRED)) : construct, this._backRefProperties, this._ignorableProps, this._ignoreAllUnknown, z);
    }
