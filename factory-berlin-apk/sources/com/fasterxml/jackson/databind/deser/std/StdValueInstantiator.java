...
public class StdValueInstantiator extends ValueInstantiator implements Serializable {
        ...
        if (annotatedWithParams == null) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                ...
                if (settableBeanProperty == null) {
                    ...
                    objArr[i2] = deserializationContext.findInjectableValue(settableBeanProperty.getInjectableValueId(), settableBeanProperty, (Object) null);
                }
            }
    ...
    public Object createUsingDefault(DeserializationContext deserializationContext) {
        ...
        try {
            ...
            return deserializationContext.handleInstantiationProblem(this._valueClass, (Object) null, rewrapCtorProblem(deserializationContext, e2));
        }
    }
