        ...
        public final Integer _parseInteger(JsonParser jsonParser, DeserializationContext deserializationContext) {
            ...
            if (currentTokenId == 6) {
                ...
                try {
                    ...
                    return (Integer) deserializationContext.handleWeirdStringValue(this._valueClass, trim, String.format("Overflow: numeric value (%s) out of range of Integer (%d - %d)", new Object[]{trim, Integer.valueOf(RecyclerView.UNDEFINED_DURATION), Integer.MAX_VALUE}), new Object[0]);
                } catch (IllegalArgumentException unused) {
