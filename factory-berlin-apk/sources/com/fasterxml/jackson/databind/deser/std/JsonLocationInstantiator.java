...
public class JsonLocationInstantiator extends ValueInstantiator.Base {
    ...
    private static CreatorProperty creatorProp(String str, JavaType javaType, int i2) {
        return new CreatorProperty(PropertyName.construct(str), javaType, (PropertyName) null, (TypeDeserializer) null, (Annotations) null, (AnnotatedParameter) null, i2, (Object) null, PropertyMetadata.STD_REQUIRED);
    }
