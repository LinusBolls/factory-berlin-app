...
public final class StringArrayDeserializer extends StdDeserializer<String[]> implements ContextualDeserializer {
    ...
    public final String[] _deserializeCustom(JsonParser jsonParser, DeserializationContext deserializationContext, String[] strArr) {
        ...
        if (strArr == null) {
            ...
            i2 = strArr.length;
            objArr = leaseObjectBuffer.resetAndStart(strArr, i2);
        }
            ...
            try {
                if (jsonParser.nextTextValue() == null) {
                    ...
                    if (currentToken == JsonToken.END_ARRAY) {
                        String[] strArr2 = (String[]) leaseObjectBuffer.completeAndClearBuffer(objArr, i2, cls);
                ...
                try {
                    ...
                    e = e2;
                    i2 = i3;
                    throw JsonMappingException.wrapWithPath((Throwable) e, (Object) cls, i2);
                }
            } catch (Exception e3) {
                e = e3;
                throw JsonMappingException.wrapWithPath((Throwable) e, (Object) cls, i2);
        ...
        while (true) {
            try {
                ...
                try {
                    ...
                    e = e2;
                    i2 = i3;
                    throw JsonMappingException.wrapWithPath((Throwable) e, (Object) resetAndStart, leaseObjectBuffer.bufferedSize() + i2);
                }
            } catch (Exception e3) {
                e = e3;
                throw JsonMappingException.wrapWithPath((Throwable) e, (Object) resetAndStart, leaseObjectBuffer.bufferedSize() + i2);
