            ...
            while (true) {
                try {
                    ...
                    try {
                        ...
                        e = e2;
                        i2 = i3;
                        throw JsonMappingException.wrapWithPath((Throwable) e, (Object) zArr, booleanBuilder.bufferedSize() + i2);
                    }
                } catch (Exception e3) {
                    e = e3;
                    throw JsonMappingException.wrapWithPath((Throwable) e, (Object) zArr, booleanBuilder.bufferedSize() + i2);
                ...
                try {
                    ...
                    if (nextToken != JsonToken.VALUE_NULL || this._nuller == null) {
                        ...
                        try {
                            ...
                            e = e2;
                            i2 = i3;
                            throw JsonMappingException.wrapWithPath((Throwable) e, (Object) dArr, doubleBuilder.bufferedSize() + i2);
                        }
                    } else {
                        this._nuller.getNullValue(deserializationContext);
                    }
                ...
                try {
                    ...
                    if (nextToken != JsonToken.VALUE_NULL || this._nuller == null) {
                        ...
                        try {
                            ...
                            e = e2;
                            i2 = i3;
                            throw JsonMappingException.wrapWithPath((Throwable) e, (Object) fArr, floatBuilder.bufferedSize() + i2);
                        }
                    } else {
                        this._nuller.getNullValue(deserializationContext);
                    }
            ...
            while (true) {
                try {
                    ...
                    try {
                        ...
                        e = e2;
                        i3 = i4;
                        throw JsonMappingException.wrapWithPath((Throwable) e, (Object) iArr, intBuilder.bufferedSize() + i3);
                    }
                } catch (Exception e3) {
                    e = e3;
                    throw JsonMappingException.wrapWithPath((Throwable) e, (Object) iArr, intBuilder.bufferedSize() + i3);
            ...
            while (true) {
                try {
                    ...
                    try {
                        ...
                        e = e2;
                        i2 = i3;
                        throw JsonMappingException.wrapWithPath((Throwable) e, (Object) jArr, longBuilder.bufferedSize() + i2);
                    }
                } catch (Exception e3) {
                    e = e3;
                    throw JsonMappingException.wrapWithPath((Throwable) e, (Object) jArr, longBuilder.bufferedSize() + i2);
            ...
            while (true) {
                try {
                    ...
                    try {
                        ...
                        e = e2;
                        i2 = i3;
                        throw JsonMappingException.wrapWithPath((Throwable) e, (Object) sArr, shortBuilder.bufferedSize() + i2);
                    }
                } catch (Exception e3) {
                    e = e3;
                    throw JsonMappingException.wrapWithPath((Throwable) e, (Object) sArr, shortBuilder.bufferedSize() + i2);
