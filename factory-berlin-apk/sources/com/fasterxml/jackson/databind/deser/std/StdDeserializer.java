...
public abstract class StdDeserializer<T> extends JsonDeserializer<T> implements Serializable {
    ...
    public final int _parseIntPrimitive(DeserializationContext deserializationContext, String str) {
        try {
            ...
            return _nonNullNumber((Number) deserializationContext.handleWeirdStringValue(this._valueClass, str, "Overflow: numeric value (%s) out of range of int (%d -%d)", str, Integer.valueOf(RecyclerView.UNDEFINED_DURATION), Integer.MAX_VALUE)).intValue();
        } catch (IllegalArgumentException unused) {
