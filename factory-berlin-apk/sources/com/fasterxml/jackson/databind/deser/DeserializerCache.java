...
public final class DeserializerCache implements Serializable {
    ...
    private com.fasterxml.jackson.databind.JavaType modifyTypeByAnnotation(com.fasterxml.jackson.databind.DeserializationContext r6, com.fasterxml.jackson.databind.introspect.Annotated r7, com.fasterxml.jackson.databind.JavaType r8) {
        /*
            r5 = this;
    ...
    public JsonDeserializer<Object> _createAndCache2(DeserializationContext deserializationContext, DeserializerFactory deserializerFactory, JavaType javaType) {
        try {
            ...
            throw JsonMappingException.from(deserializationContext, ClassUtil.exceptionMessage(e2), (Throwable) e2);
        }
    }
