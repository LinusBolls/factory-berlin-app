    ...
    public final void deserializeAndSet(JsonParser jsonParser, DeserializationContext deserializationContext, Object obj, String str) {
        ...
        try {
            if (this._keyDeserializer == null) {
                ...
                obj2 = this._keyDeserializer.deserializeKey(str, deserializationContext);
            }
            ...
            throw JsonMappingException.from(jsonParser, "Unresolved forward reference but no identity info.", (Throwable) e2);
        }
    }
