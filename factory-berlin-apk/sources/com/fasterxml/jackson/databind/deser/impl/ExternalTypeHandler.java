...
public class ExternalTypeHandler {
    ...
    private final boolean _handleTypePropertyValue(JsonParser jsonParser, DeserializationContext deserializationContext, String str, Object obj, String str2, int i2) {
        boolean z = false;
    ...
    public final Object _deserialize(JsonParser jsonParser, DeserializationContext deserializationContext, int i2, String str) {
    ...
    /* access modifiers changed from: protected */
    public final void _deserializeAndSet(JsonParser jsonParser, DeserializationContext deserializationContext, Object obj, int i2, String str) {
        JsonParser asParser = this._tokens[i2].asParser(jsonParser);
        if (asParser.nextToken() == JsonToken.VALUE_NULL) {
            this._properties[i2].getProperty().set(obj, (Object) null);
            return;
        }
        TokenBuffer tokenBuffer = new TokenBuffer(jsonParser, deserializationContext);
        tokenBuffer.writeStartArray();
            ...
            if (str == null) {
                ...
                if (tokenBuffer == null) {
                    ...
                    if (deserializeIfNatural != null) {
                        ...
                        deserializationContext.reportInputMismatch(obj.getClass(), "Missing external type id property '%s'", this._properties[i2].getTypePropertyName());
                        throw null;
                    }
                }
                ...
                deserializationContext.reportInputMismatch(obj.getClass(), "Missing property '%s' for external type id '%s'", property2.getName(), this._properties[i2].getTypePropertyName());
                throw null;
            }
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            if (str2 != null) {
                ...
                if (this._tokens[i2] == null) {
                    ...
                    deserializationContext.reportInputMismatch(this._beanType, "Missing property '%s' for external type id '%s'", property.getName(), this._properties[i2].getTypePropertyName());
                    throw null;
                }
            } else if (this._tokens[i2] == null) {
                continue;
