...
public abstract class JavaUtilCollectionsDeserializers {
    ...
    private static class JavaUtilCollectionsConverter implements Converter<Object, Object> {
        ...
        private void _checkSingleton(int i2) {
            if (i2 != 1) {
        ...
        private JavaUtilCollectionsConverter(int i2, JavaType javaType) {
    ...
    static JavaUtilCollectionsConverter converter(int i2, JavaType javaType, Class<?> cls) {
