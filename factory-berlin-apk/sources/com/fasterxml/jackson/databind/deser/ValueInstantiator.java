...
public abstract class ValueInstantiator {
    ...
    public Object createFromInt(DeserializationContext deserializationContext, int i2) {
        return deserializationContext.handleMissingInstantiator(getValueClass(), this, (JsonParser) null, "no int/Int-argument constructor/factory method to deserialize from Number value (%s)", Integer.valueOf(i2));
    }
