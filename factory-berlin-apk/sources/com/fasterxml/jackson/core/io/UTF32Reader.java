...
public class UTF32Reader extends Reader {
    ...
    private void reportBounds(char[] cArr, int i2, int i3) {
        throw new ArrayIndexOutOfBoundsException("read(buf," + i2 + AndroidSdkMetrics.SEPARATOR + i3 + "), cbuf[" + cArr.length + "]");
    }
    ...
    private void reportUnexpectedEOF(int i2, int i3) {
        ...
        throw new CharConversionException("Unexpected EOF in the middle of a 4-byte UTF-32 char: got " + i2 + ", needed " + i3 + ", at char #" + i4 + ", byte #" + (this._byteCount + i2) + ")");
    }
