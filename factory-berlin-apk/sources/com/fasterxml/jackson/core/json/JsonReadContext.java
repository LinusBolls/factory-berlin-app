...
public final class JsonReadContext extends JsonStreamContext {
    ...
    public JsonReadContext createChildArrayContext(int i2, int i3) {
        ...
        if (jsonReadContext == null) {
            ...
            jsonReadContext = new JsonReadContext(this, dupDetector, 1, i2, i3);
    ...
    public JsonReadContext createChildObjectContext(int i2, int i3) {
        ...
        if (jsonReadContext == null) {
            ...
            JsonReadContext jsonReadContext2 = new JsonReadContext(this, dupDetector, 2, i2, i3);
