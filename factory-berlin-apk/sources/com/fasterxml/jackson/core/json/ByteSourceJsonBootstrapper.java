...
public final class ByteSourceJsonBootstrapper {
    ...
    public JsonParser constructParser(int i2, ObjectCodec objectCodec, ByteQuadsCanonicalizer byteQuadsCanonicalizer, CharsToNameCanonicalizer charsToNameCanonicalizer, int i3) {
        int i4 = i3;
        if (detectEncoding() != JsonEncoding.UTF8 || !JsonFactory.Feature.CANONICALIZE_FIELD_NAMES.enabledIn(i4)) {
            return new ReaderBasedJsonParser(this._context, i2, constructReader(), objectCodec, charsToNameCanonicalizer.makeChild(i3));
        }
        return new UTF8StreamJsonParser(this._context, i2, this._in, objectCodec, byteQuadsCanonicalizer.makeChild(i4), this._inputBuffer, this._inputPtr, this._inputEnd, this._bufferRecyclable);
    }
    ...
    public boolean ensureLoaded(int i2) {
        int i3;
