...
/* compiled from: FragInfoItemUnreadBindingImpl */
public class t extends s {
    ...
    static {
        ...
        C = sparseIntArray;
        sparseIntArray.put(R.id.unread_title, 1);
        C.put(R.id.unread_time, 2);
        C.put(R.id.unread_body, 3);
        C.put(R.id.unread_chevron, 4);
    }
