...
public final class k {
    ...
    public static final int[] IotDeviceDetailHeaderView = {R.attr.header_editable, R.attr.header_icon, R.attr.header_title};
    public static final int IotDeviceDetailHeaderView_header_editable = 0;
    public static final int IotDeviceDetailHeaderView_header_icon = 1;
    public static final int IotDeviceDetailHeaderView_header_title = 2;
    public static final int[] IotDeviceDetailSwitch = {R.attr.switch_state, R.attr.switch_subtitle, R.attr.switch_title};
    public static final int IotDeviceDetailSwitch_switch_state = 0;
    public static final int IotDeviceDetailSwitch_switch_subtitle = 1;
    public static final int IotDeviceDetailSwitch_switch_title = 2;
    public static final int[] IotDeviceDetailsSeekBar = {R.attr.seekbar_max, R.attr.seekbar_progress, R.attr.seekbar_textPadding, R.attr.seekbar_textSize, R.attr.seekbar_title};
    public static final int IotDeviceDetailsSeekBar_seekbar_max = 0;
    public static final int IotDeviceDetailsSeekBar_seekbar_progress = 1;
    public static final int IotDeviceDetailsSeekBar_seekbar_textPadding = 2;
    public static final int IotDeviceDetailsSeekBar_seekbar_textSize = 3;
    public static final int IotDeviceDetailsSeekBar_seekbar_title = 4;
    ...
    public static final int[] PinView = {R.attr.pin_drawable, R.attr.pin_length, R.attr.pin_padding};
    public static final int PinView_pin_drawable = 0;
    public static final int PinView_pin_length = 1;
    public static final int PinView_pin_padding = 2;
