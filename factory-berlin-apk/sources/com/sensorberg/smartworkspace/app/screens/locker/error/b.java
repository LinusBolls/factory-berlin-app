...
/* compiled from: LockerErrorFragmentDirections.kt */
public final class b {
    ...
    public static final class a {
        ...
        public final p a(LockerGroupSelection lockerGroupSelection, IotUnit iotUnit) {
            return new C0512b(lockerGroupSelection, iotUnit);
        }

        public final p b() {
            return new androidx.navigation.a(R.id.to_lockerEndingFragment);
        }

        public final p c(IotUnit iotUnit, boolean z) {
            k.e(iotUnit, "iotUnit");
    ...
    /* renamed from: com.sensorberg.smartworkspace.app.screens.locker.error.b$b  reason: collision with other inner class name */
    /* compiled from: LockerErrorFragmentDirections.kt */
    private static final class C0512b implements p {
        private final LockerGroupSelection a;
        private final IotUnit b;

        public C0512b(LockerGroupSelection lockerGroupSelection, IotUnit iotUnit) {
