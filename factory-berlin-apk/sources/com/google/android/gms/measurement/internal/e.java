...
public final class e {
    ...
    public static e j(Bundle bundle) {
        ...
        return new e(m(bundle.getString("ad_storage")), m(bundle.getString("analytics_storage")));
    }
    ...
    private static Boolean m(String str) {
        ...
        if (str.equals(ActuatorRequest.STATE_DENIED)) {
            return Boolean.FALSE;
        }
        return null;
    }
    ...
    public final String toString() {
        ...
        if (bool == null) {
            ...
            sb.append(bool.booleanValue() ? str : ActuatorRequest.STATE_DENIED);
        }
        ...
        if (bool2 == null) {
            ...
            if (!bool2.booleanValue()) {
                str = ActuatorRequest.STATE_DENIED;
            }
            sb.append(str);
        }
        return sb.toString();
