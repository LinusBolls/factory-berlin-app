...
final class j7 implements Application.ActivityLifecycleCallbacks {
    ...
    private final /* synthetic */ l6 f2911g;
    ...
    public final void i(boolean r18, android.net.Uri r19, java.lang.String r20, java.lang.String r21) {
        /*
            r17 = this;
            r1 = r17
            r0 = r20
            r2 = r21
            com.google.android.gms.measurement.internal.l6 r3 = r1.f2911g
            r3.c()
            com.google.android.gms.measurement.internal.l6 r3 = r1.f2911g     // Catch:{ Exception -> 0x01d6 }
            com.google.android.gms.measurement.internal.wa r3 = r3.l()     // Catch:{ Exception -> 0x01d6 }
        ...
        L_0x0051:
            ...
            if (r11 != 0) goto L_0x0075
            com.google.android.gms.measurement.internal.c4 r3 = r3.i()     // Catch:{ Exception -> 0x01d6 }
        ...
        L_0x009b:
            ...
            com.google.android.gms.measurement.internal.l6 r14 = r1.f2911g     // Catch:{ Exception -> 0x01d6 }
            ...
            com.google.android.gms.measurement.internal.l6 r6 = r1.f2911g     // Catch:{ Exception -> 0x01d6 }
            com.google.android.gms.measurement.internal.wa r6 = r6.l()     // Catch:{ Exception -> 0x01d6 }
        ...
        L_0x00e3:
            ...
            com.google.android.gms.measurement.internal.l6 r6 = r1.f2911g     // Catch:{ Exception -> 0x01d6 }
            com.google.android.gms.measurement.internal.na r6 = r6.f2952n     // Catch:{ Exception -> 0x01d6 }
        ...
        L_0x013f:
            com.google.android.gms.measurement.internal.l6 r6 = r1.f2911g     // Catch:{ Exception -> 0x01d6 }
            com.google.android.gms.measurement.internal.c4 r6 = r6.i()     // Catch:{ Exception -> 0x01d6 }
            ...
            com.google.android.gms.measurement.internal.l6 r2 = r1.f2911g     // Catch:{ Exception -> 0x01d6 }
            r2.X(r0, r12, r3)     // Catch:{ Exception -> 0x01d6 }
            com.google.android.gms.measurement.internal.l6 r2 = r1.f2911g     // Catch:{ Exception -> 0x01d6 }
            com.google.android.gms.measurement.internal.wa r2 = r2.l()     // Catch:{ Exception -> 0x01d6 }
            ...
            com.google.android.gms.measurement.internal.l6 r2 = r1.f2911g     // Catch:{ Exception -> 0x01d6 }
            com.google.android.gms.measurement.internal.na r2 = r2.f2952n     // Catch:{ Exception -> 0x01d6 }
            r2.b(r0, r3)     // Catch:{ Exception -> 0x01d6 }
            goto L_0x018a
        L_0x017b:
            com.google.android.gms.measurement.internal.l6 r0 = r1.f2911g     // Catch:{ Exception -> 0x01d6 }
            com.google.android.gms.measurement.internal.c4 r0 = r0.i()     // Catch:{ Exception -> 0x01d6 }
        ...
        L_0x01d6:
            r0 = move-exception
            com.google.android.gms.measurement.internal.l6 r2 = r1.f2911g
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.j7.i(boolean, android.net.Uri, java.lang.String, java.lang.String):void");
    }

    public final void onActivityCreated(Activity activity, Bundle bundle) {
        try {
            this.f2911g.i().M().a("onActivityCreated");
            ...
            if (intent != null) {
                ...
                if (data != null) {
                    if (data.isHierarchical()) {
                        this.f2911g.g();
                        this.f2911g.a().y(new m7(this, bundle == null, data, fa.Z(intent) ? "gs" : "auto", data.getQueryParameter("referrer")));
                        this.f2911g.s().G(activity, bundle);
                        return;
                    }
                }
                this.f2911g.s().G(activity, bundle);
            ...
            this.f2911g.i().E().b("Throwable caught in onActivityCreated", e2);
        } finally {
            this.f2911g.s().G(activity, bundle);
        }
    }
    ...
    public final void onActivityDestroyed(Activity activity) {
        this.f2911g.s().V(activity);
    }

    public final void onActivityPaused(Activity activity) {
        this.f2911g.s().T(activity);
        j9 u = this.f2911g.u();
        u.a().y(new l9(u, u.f().c()));
    }

    public final void onActivityResumed(Activity activity) {
        j9 u = this.f2911g.u();
        u.a().y(new i9(u, u.f().c()));
        this.f2911g.s().F(activity);
    }

    public final void onActivitySaveInstanceState(Activity activity, Bundle bundle) {
        this.f2911g.s().U(activity, bundle);
    }
