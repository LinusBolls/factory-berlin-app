...
final class d extends u9 {
    ...
    public static final String[] f2779f = {"last_bundled_timestamp", "ALTER TABLE events ADD COLUMN last_bundled_timestamp INTEGER;", "last_bundled_day", "ALTER TABLE events ADD COLUMN last_bundled_day INTEGER;", "last_sampled_complex_event_id", "ALTER TABLE events ADD COLUMN last_sampled_complex_event_id INTEGER;", "last_sampling_rate", "ALTER TABLE events ADD COLUMN last_sampling_rate INTEGER;", "last_exempt_from_sampling", "ALTER TABLE events ADD COLUMN last_exempt_from_sampling INTEGER;", "current_session_count", "ALTER TABLE events ADD COLUMN current_session_count INTEGER;"};
    /* access modifiers changed from: private */

    /* renamed from: g  reason: collision with root package name */
    public static final String[] f2780g = {"origin", "ALTER TABLE user_attributes ADD COLUMN origin TEXT;"};
    /* access modifiers changed from: private */

    /* renamed from: h  reason: collision with root package name */
    public static final String[] f2781h = {"app_version", "ALTER TABLE apps ADD COLUMN app_version TEXT;", "app_store", "ALTER TABLE apps ADD COLUMN app_store TEXT;", "gmp_version", "ALTER TABLE apps ADD COLUMN gmp_version INTEGER;", "dev_cert_hash", "ALTER TABLE apps ADD COLUMN dev_cert_hash INTEGER;", "measurement_enabled", "ALTER TABLE apps ADD COLUMN measurement_enabled INTEGER;", "last_bundle_start_timestamp", "ALTER TABLE apps ADD COLUMN last_bundle_start_timestamp INTEGER;", "day", "ALTER TABLE apps ADD COLUMN day INTEGER;", "daily_public_events_count", "ALTER TABLE apps ADD COLUMN daily_public_events_count INTEGER;", "daily_events_count", "ALTER TABLE apps ADD COLUMN daily_events_count INTEGER;", "daily_conversions_count", "ALTER TABLE apps ADD COLUMN daily_conversions_count INTEGER;", "remote_config", "ALTER TABLE apps ADD COLUMN remote_config BLOB;", "config_fetched_time", "ALTER TABLE apps ADD COLUMN config_fetched_time INTEGER;", "failed_config_fetch_time", "ALTER TABLE apps ADD COLUMN failed_config_fetch_time INTEGER;", "app_version_int", "ALTER TABLE apps ADD COLUMN app_version_int INTEGER;", "firebase_instance_id", "ALTER TABLE apps ADD COLUMN firebase_instance_id TEXT;", "daily_error_events_count", "ALTER TABLE apps ADD COLUMN daily_error_events_count INTEGER;", "daily_realtime_events_count", "ALTER TABLE apps ADD COLUMN daily_realtime_events_count INTEGER;", "health_monitor_sample", "ALTER TABLE apps ADD COLUMN health_monitor_sample TEXT;", "android_id", "ALTER TABLE apps ADD COLUMN android_id INTEGER;", "adid_reporting_enabled", "ALTER TABLE apps ADD COLUMN adid_reporting_enabled INTEGER;", "ssaid_reporting_enabled", "ALTER TABLE apps ADD COLUMN ssaid_reporting_enabled INTEGER;", "admob_app_id", "ALTER TABLE apps ADD COLUMN admob_app_id TEXT;", "linked_admob_app_id", "ALTER TABLE apps ADD COLUMN linked_admob_app_id TEXT;", "dynamite_version", "ALTER TABLE apps ADD COLUMN dynamite_version INTEGER;", "safelisted_events", "ALTER TABLE apps ADD COLUMN safelisted_events TEXT;", "ga_app_id", "ALTER TABLE apps ADD COLUMN ga_app_id TEXT;"};
    /* access modifiers changed from: private */

    /* renamed from: i  reason: collision with root package name */
    public static final String[] f2782i = {"realtime", "ALTER TABLE raw_events ADD COLUMN realtime INTEGER;"};
    /* access modifiers changed from: private */

    /* renamed from: j  reason: collision with root package name */
    public static final String[] f2783j = {"has_realtime", "ALTER TABLE queue ADD COLUMN has_realtime INTEGER;", "retry_count", "ALTER TABLE queue ADD COLUMN retry_count INTEGER;"};
    /* access modifiers changed from: private */

    /* renamed from: k  reason: collision with root package name */
    public static final String[] f2784k = {"session_scoped", "ALTER TABLE event_filters ADD COLUMN session_scoped BOOLEAN;"};
    /* access modifiers changed from: private */

    /* renamed from: l  reason: collision with root package name */
    public static final String[] f2785l = {"session_scoped", "ALTER TABLE property_filters ADD COLUMN session_scoped BOOLEAN;"};
    /* access modifiers changed from: private */

    /* renamed from: m  reason: collision with root package name */
    public static final String[] f2786m = {"previous_install_count", "ALTER TABLE app2 ADD COLUMN previous_install_count INTEGER;"};

    /* renamed from: d  reason: collision with root package name */
    private final i f2787d = new i(this, j(), "google_app_measurement.db");
    /* access modifiers changed from: private */

    /* renamed from: e  reason: collision with root package name */
    public final q9 f2788e = new q9(f());
    ...
    private final boolean V(String str, int i2, l0 l0Var) {
        r();
        c();
        r.g(str);
        r.k(l0Var);
        ...
        contentValues.put("filter_id", l0Var.G() ? Integer.valueOf(l0Var.H()) : null);
        contentValues.put("event_name", l0Var.I());
        contentValues.put("session_scoped", l0Var.P() ? Boolean.valueOf(l0Var.Q()) : null);
        contentValues.put("data", i3);
        try {
            if (v().insertWithOnConflict("event_filters", (String) null, contentValues, 5) != -1) {
                return true;
            }
            i().E().b("Failed to insert event filter (got -1). appId", c4.w(str));
            return true;
        } catch (SQLiteException e2) {
            i().E().c("Error storing event filter. appId", c4.w(str), e2);
            return false;
        }
    }

    private final boolean W(String str, int i2, o0 o0Var) {
        r();
        c();
        r.g(str);
        r.k(o0Var);
        ...
        contentValues.put("app_id", str);
        contentValues.put("audience_id", Integer.valueOf(i2));
        contentValues.put("filter_id", o0Var.D() ? Integer.valueOf(o0Var.E()) : null);
        contentValues.put("property_name", o0Var.F());
        contentValues.put("session_scoped", o0Var.J() ? Boolean.valueOf(o0Var.K()) : null);
        contentValues.put("data", i3);
        try {
            if (v().insertWithOnConflict("property_filters", (String) null, contentValues, 5) != -1) {
                return true;
            }
            i().E().b("Failed to insert property filter (got -1). appId", c4.w(str));
            return false;
        } catch (SQLiteException e2) {
            i().E().c("Error storing property filter. appId", c4.w(str), e2);
            return false;
        }
    }
    ...
    private final boolean m0(String str, List<Integer> list) {
        ...
        try {
            ...
            int max = Math.max(0, Math.min(2000, l().u(str, u.F)));
            if (i0 <= ((long) max)) {
                return false;
            }
            ...
            String join = TextUtils.join(AndroidSdkMetrics.SEPARATOR, arrayList);
            ...
            i().E().c("Database error querying filters. appId", c4.w(str), e2);
            return false;
        }
    }
    ...
    public final android.util.Pair<com.google.android.gms.internal.measurement.a1, java.lang.Long> A(java.lang.String r8, java.lang.Long r9) {
        /*
            r7 = this;
            r7.c()
            r7.r()
            ...
            com.google.android.gms.measurement.internal.c4 r8 = r7.i()     // Catch:{ SQLiteException -> 0x0076 }
        ...
        L_0x0037:
            ...
            com.google.android.gms.internal.measurement.a1$a r4 = com.google.android.gms.internal.measurement.a1.b0()     // Catch:{ IOException -> 0x005e }
            com.google.android.gms.measurement.internal.ba.z(r4, r2)     // Catch:{ IOException -> 0x005e }
            com.google.android.gms.internal.measurement.a1$a r4 = (com.google.android.gms.internal.measurement.a1.a) r4     // Catch:{ IOException -> 0x005e }
            com.google.android.gms.internal.measurement.j8 r2 = r4.l()     // Catch:{ IOException -> 0x005e }
            com.google.android.gms.internal.measurement.z6 r2 = (com.google.android.gms.internal.measurement.z6) r2     // Catch:{ IOException -> 0x005e }
            com.google.android.gms.internal.measurement.a1 r2 = (com.google.android.gms.internal.measurement.a1) r2     // Catch:{ IOException -> 0x005e }
        ...
        L_0x005e:
            r2 = move-exception
            com.google.android.gms.measurement.internal.c4 r3 = r7.i()     // Catch:{ SQLiteException -> 0x0076 }
        ...
        L_0x007a:
            ...
            r1 = r0
        L_0x007c:
            com.google.android.gms.measurement.internal.c4 r9 = r7.i()     // Catch:{ all -> 0x008f }
        ...
        try {
            ...
            try {
                ...
                if (z == -1) {
                    ...
                    if (v.insertWithOnConflict("app2", (String) null, contentValues, 5) == -1) {
                        i().E().c("Failed to insert column (got -1). appId", c4.w(str), str4);
                        v.endTransaction();
                        return -1;
                    }
                    z = 0;
                ...
                e = e2;
                try {
                    i().E().d("Error inserting column. appId", c4.w(str), str4, e);
                    v.endTransaction();
                    return j2;
                } catch (Throwable th) {
                    th = th;
            ...
            try {
                ...
                if (((long) v.update("app2", contentValues2, "app_id = ?", new String[]{str3})) == 0) {
                    i().E().c("Failed to update column (got 0). appId", c4.w(str), str4);
                    v.endTransaction();
                    return -1;
                }
    ...
    public final g B(long j2, String str, long j3, boolean z, boolean z2, boolean z3, boolean z4, boolean z5) {
        ...
        try {
            ...
            if (!cursor.moveToFirst()) {
                i().H().b("Not updating daily counts, app is not known. appId", c4.w(str));
                if (cursor != null) {
                    cursor.close();
                }
                return gVar;
            ...
            if (cursor.getLong(0) == j2) {
                ...
                gVar.f2849d = cursor.getLong(4);
                gVar.f2850e = cursor.getLong(5);
            }
            if (z) {
                gVar.b += j3;
            }
            ...
            contentValues.put("daily_error_events_count", Long.valueOf(gVar.f2849d));
            contentValues.put("daily_realtime_events_count", Long.valueOf(gVar.f2850e));
            ...
            i().E().c("Error updating daily counts. appId", c4.w(str), e2);
            if (cursor != null) {
                cursor.close();
            }
            return gVar;
    ...
    public final android.os.Bundle B0(java.lang.String r8) {
        /*
            ...
            com.google.android.gms.measurement.internal.c4 r8 = r7.i()     // Catch:{ SQLiteException -> 0x00bb }
        ...
        L_0x0030:
            ...
            com.google.android.gms.internal.measurement.a1$a r3 = com.google.android.gms.internal.measurement.a1.b0()     // Catch:{ IOException -> 0x00a3 }
            com.google.android.gms.measurement.internal.ba.z(r3, r2)     // Catch:{ IOException -> 0x00a3 }
            com.google.android.gms.internal.measurement.a1$a r3 = (com.google.android.gms.internal.measurement.a1.a) r3     // Catch:{ IOException -> 0x00a3 }
            com.google.android.gms.internal.measurement.j8 r2 = r3.l()     // Catch:{ IOException -> 0x00a3 }
            com.google.android.gms.internal.measurement.z6 r2 = (com.google.android.gms.internal.measurement.z6) r2     // Catch:{ IOException -> 0x00a3 }
            com.google.android.gms.internal.measurement.a1 r2 = (com.google.android.gms.internal.measurement.a1) r2     // Catch:{ IOException -> 0x00a3 }
            r7.m()     // Catch:{ SQLiteException -> 0x00bb }
            java.util.List r8 = r2.C()     // Catch:{ SQLiteException -> 0x00bb }
        ...
        L_0x0055:
            ...
            com.google.android.gms.internal.measurement.c1 r3 = (com.google.android.gms.internal.measurement.c1) r3     // Catch:{ SQLiteException -> 0x00bb }
            java.lang.String r4 = r3.M()     // Catch:{ SQLiteException -> 0x00bb }
            ...
            goto L_0x0055
        L_0x0073:
            boolean r5 = r3.X()     // Catch:{ SQLiteException -> 0x00bb }
            if (r5 == 0) goto L_0x0081
            float r3 = r3.Y()     // Catch:{ SQLiteException -> 0x00bb }
            r2.putFloat(r4, r3)     // Catch:{ SQLiteException -> 0x00bb }
            goto L_0x0055
        L_0x0081:
            boolean r5 = r3.R()     // Catch:{ SQLiteException -> 0x00bb }
            if (r5 == 0) goto L_0x008f
            java.lang.String r3 = r3.S()     // Catch:{ SQLiteException -> 0x00bb }
            r2.putString(r4, r3)     // Catch:{ SQLiteException -> 0x00bb }
            goto L_0x0055
        L_0x008f:
            boolean r5 = r3.V()     // Catch:{ SQLiteException -> 0x00bb }
            if (r5 == 0) goto L_0x0055
            long r5 = r3.W()     // Catch:{ SQLiteException -> 0x00bb }
        ...
        L_0x00a3:
            r2 = move-exception
            com.google.android.gms.measurement.internal.c4 r3 = r7.i()     // Catch:{ SQLiteException -> 0x00bb }
        ...
        L_0x00bf:
            ...
            r1 = r0
        L_0x00c1:
            com.google.android.gms.measurement.internal.c4 r2 = r7.i()     // Catch:{ all -> 0x00d4 }
    ...
    public final com.google.android.gms.measurement.internal.o D(java.lang.String r26, java.lang.String r27) {
        /*
            r25 = this;
            r15 = r27
            com.google.android.gms.common.internal.r.g(r26)
            com.google.android.gms.common.internal.r.g(r27)
            r25.c()
            r25.r()
        ...
        L_0x00e1:
            ...
            com.google.android.gms.measurement.internal.c4 r0 = r25.i()     // Catch:{ SQLiteException -> 0x0117, all -> 0x0115 }
        ...
        L_0x0127:
            ...
            r14 = r18
        L_0x012a:
            com.google.android.gms.measurement.internal.c4 r1 = r25.i()     // Catch:{ all -> 0x014b }
            ...
            com.google.android.gms.measurement.internal.a4 r4 = r25.e()     // Catch:{ all -> 0x014b }
            r5 = r27
    ...
    public final void D0() {
        ...
        if (h0()) {
            long a = k().f3028h.a();
            long c = f().c();
            if (Math.abs(c - a) > u.y.a(null).longValue()) {
                k().f3028h.b(c);
                c();
                r();
                if (h0() && (delete = v().delete("queue", "abs(bundle_end_timestamp - ?) > cast(? as integer)", new String[]{String.valueOf(f().b()), String.valueOf(wa.J())})) > 0) {
                    i().M().b("Deleted stale rows. rowsDeleted", Integer.valueOf(delete));
                }
            }
        }
    }
    ...
    public final java.lang.String G(long r5) {
        /*
            ...
            com.google.android.gms.measurement.internal.c4 r6 = r4.i()     // Catch:{ SQLiteException -> 0x003e }
        ...
        L_0x0042:
            ...
            r5 = r0
        L_0x0044:
            com.google.android.gms.measurement.internal.c4 r1 = r4.i()     // Catch:{ all -> 0x0057 }
    ...
    public final java.util.List<com.google.android.gms.measurement.internal.ga> I(java.lang.String r14) {
        ...
        L_0x004b:
            ...
            com.google.android.gms.measurement.internal.c4 r3 = r13.i()     // Catch:{ SQLiteException -> 0x0080 }
        ...
        L_0x0084:
            ...
            r2 = r1
        L_0x0086:
            com.google.android.gms.measurement.internal.c4 r3 = r13.i()     // Catch:{ all -> 0x00b9 }
            ...
            boolean r0 = com.google.android.gms.internal.measurement.cc.a()     // Catch:{ all -> 0x00b9 }
            if (r0 == 0) goto L_0x00b3
            com.google.android.gms.measurement.internal.wa r0 = r13.l()     // Catch:{ all -> 0x00b9 }
    ...
    public final long I0() {
        ...
        try {
            ...
            i().E().b("Error querying raw events", e2);
            if (cursor != null) {
                cursor.close();
            }
            return -1;
    ...
    public final List<Pair<e1, Long>> J(String str, int i2, int i3) {
        c();
        r();
        r.a(i2 > 0);
        r.a(i3 > 0);
        ...
        try {
            ...
            do {
                ...
                try {
                    ...
                    try {
                        ...
                        i4 += V.length;
                        arrayList.add(Pair.create((e1) ((z6) aVar.l()), Long.valueOf(j2)));
                    } catch (IOException e2) {
                        i().E().c("Failed to merge queued bundle. appId", c4.w(str), e2);
                    }
                    if (!cursor.moveToNext()) {
                        break;
                    }
                } catch (IOException e3) {
                    i().E().c("Failed to unzip queued bundle. appId", c4.w(str), e3);
                }
            } while (i4 <= i3);
            if (cursor != null) {
                cursor.close();
            ...
            i().E().c("Error querying bundles. appId", c4.w(str), e4);
    ...
    public final java.util.List<com.google.android.gms.measurement.internal.ga> K(java.lang.String r21, java.lang.String r22, java.lang.String r23) {
        /*
            r20 = this;
            r8 = r21
            com.google.android.gms.common.internal.r.g(r21)
            r20.c()
            r20.r()
            java.util.ArrayList r0 = new java.util.ArrayList
            r0.<init>()
        ...
        L_0x0087:
            ...
            com.google.android.gms.measurement.internal.c4 r1 = r20.i()     // Catch:{ SQLiteException -> 0x00f3, all -> 0x00ef }
        ...
        L_0x00a3:
            ...
            com.google.android.gms.measurement.internal.c4 r1 = r20.i()     // Catch:{ SQLiteException -> 0x00ea }
        ...
        L_0x0104:
            r11 = r9
        L_0x0105:
            com.google.android.gms.measurement.internal.c4 r1 = r20.i()     // Catch:{ all -> 0x0138 }
            ...
            boolean r0 = com.google.android.gms.internal.measurement.cc.a()     // Catch:{ all -> 0x0138 }
            if (r0 == 0) goto L_0x0132
            com.google.android.gms.measurement.internal.wa r0 = r20.l()     // Catch:{ all -> 0x0138 }
        ...
        try {
            ...
            while (true) {
                if (arrayList.size() < 1000) {
                    ...
                    boolean z2 = z;
                    ua uaVar = r3;
                    ua uaVar2 = new ua(string, string2, new ea(string3, j4, F, string2), j3, z2, string4, (s) m().w(cursor.getBlob(7), s.CREATOR), j2, (s) m().w(cursor.getBlob(9), s.CREATOR), cursor.getLong(11), (s) m().w(cursor.getBlob(12), s.CREATOR));
                    arrayList.add(uaVar);
                    if (!cursor.moveToNext()) {
                        break;
                    }
            ...
            i().E().b("Error querying conditional user property value", e2);
    ...
    public final void N(o oVar) {
        ...
        contentValues.put("current_bundle_count", Long.valueOf(oVar.f3003d));
        contentValues.put("last_fire_timestamp", Long.valueOf(oVar.f3005f));
        contentValues.put("last_bundled_timestamp", Long.valueOf(oVar.f3006g));
        contentValues.put("last_bundled_day", oVar.f3007h);
        contentValues.put("last_sampled_complex_event_id", oVar.f3008i);
        contentValues.put("last_sampling_rate", oVar.f3009j);
        contentValues.put("current_session_count", Long.valueOf(oVar.f3004e));
        Boolean bool = oVar.f3010k;
        contentValues.put("last_exempt_from_sampling", (bool == null || !bool.booleanValue()) ? null : 1L);
        try {
            if (v().insertWithOnConflict("events", (String) null, contentValues, 5) == -1) {
                i().E().b("Failed to insert/update event aggregates (got -1). appId", c4.w(oVar.a));
            }
        } catch (SQLiteException e2) {
            i().E().c("Error storing event aggregates. appId", c4.w(oVar.a), e2);
        }
    }
    ...
    public final void O(f4 f4Var) {
        ...
        if (f4Var.o() != null) {
            if (f4Var.o().size() == 0) {
                i().H().b("Safelisted events should not be an empty list. appId", f4Var.t());
            } else {
                contentValues.put("safelisted_events", TextUtils.join(AndroidSdkMetrics.SEPARATOR, f4Var.o()));
            }
        }
        if (vc.a() && l().C(f4Var.t(), u.k0)) {
        ...
        try {
            ...
            if (((long) v.update("apps", contentValues, "app_id = ?", new String[]{f4Var.t()})) == 0 && v.insertWithOnConflict("apps", (String) null, contentValues, 5) == -1) {
                i().E().b("Failed to insert/update app (got -1). appId", c4.w(f4Var.t()));
            }
        } catch (SQLiteException e2) {
            i().E().c("Error storing app. appId", c4.w(f4Var.t()), e2);
        }
    }

    /* access modifiers changed from: package-private */
    public final void P(String str, List<k0> list) {
        boolean z;
        boolean z2;
        String str2 = str;
        List<k0> list2 = list;
        r.k(list);
        for (int i2 = 0; i2 < list.size(); i2++) {
            k0.a aVar = (k0.a) list2.get(i2).x();
            if (aVar.D() != 0) {
                for (int i3 = 0; i3 < aVar.D(); i3++) {
                    l0.a aVar2 = (l0.a) aVar.E(i3).x();
                    l0.a aVar3 = (l0.a) ((z6.b) aVar2.clone());
                    String b = e6.b(aVar2.C());
                    if (b != null) {
                        aVar3.A(b);
                        z2 = true;
                    } else {
                    ...
                    for (int i4 = 0; i4 < aVar2.D(); i4++) {
                        ...
                        if (a != null) {
                            m0.a aVar4 = (m0.a) B.x();
                            aVar4.z(a);
                            aVar3.z(i4, (m0) ((z6) aVar4.l()));
                            z2 = true;
                        }
                    }
                    if (z2) {
                        aVar.A(i3, aVar3);
                        list2.set(i2, (k0) ((z6) aVar.l()));
                    }
                }
            }
            if (aVar.z() != 0) {
        ...
        try {
            ...
            for (k0 next : list) {
                ...
                r.k(next);
                if (!next.G()) {
                    i().H().b("Audience with no ID. appId", c4.w(str));
                } else {
                    int H = next.H();
                    Iterator<l0> it = next.L().iterator();
                    while (true) {
                        if (it.hasNext()) {
                            if (!it.next().G()) {
                                i().H().c("Event filter with no ID. Audience definition ignored. appId, audienceId", c4.w(str), Integer.valueOf(H));
                                break;
                            }
                        } else {
                            Iterator<o0> it2 = next.J().iterator();
                            while (true) {
                                if (it2.hasNext()) {
                                    if (!it2.next().D()) {
                                        i().H().c("Property filter with no ID. Audience definition ignored. appId, audienceId", c4.w(str), Integer.valueOf(H));
                                        break;
                                    }
                                } else {
                                    Iterator<l0> it3 = next.L().iterator();
                                    while (true) {
                                        if (it3.hasNext()) {
                                            if (!V(str2, H, it3.next())) {
                                                z = false;
                                                break;
                                            }
                                        } else {
                                    ...
                                    if (z) {
                                        Iterator<o0> it4 = next.J().iterator();
                                        while (true) {
                                            if (it4.hasNext()) {
                                                if (!W(str2, H, it4.next())) {
                                                    z = false;
                                                    break;
                                                }
                                            } else {
                                    ...
                                    if (!z) {
                                        ...
                                        r.g(str);
                                        SQLiteDatabase v3 = v();
                                        v3.delete("property_filters", "app_id=? and audience_id=?", new String[]{str2, String.valueOf(H)});
                                        v3.delete("event_filters", "app_id=? and audience_id=?", new String[]{str2, String.valueOf(H)});
                                    }
                                }
                            }
                        }
    ...
    public final void Q(List<Long> list) {
        ...
        r.m(list.size());
        if (h0()) {
            String join = TextUtils.join(AndroidSdkMetrics.SEPARATOR, list);
            StringBuilder sb = new StringBuilder(String.valueOf(join).length() + 2);
            sb.append("(");
            sb.append(join);
            sb.append(")");
            ...
            if (i0(sb3.toString(), (String[]) null) > 0) {
                i().H().a("The number of upload retries exceeds the limit. Will remain unchanged.");
            }
            try {
                SQLiteDatabase v = v();
                ...
                i().E().b("Error incrementing retry count. error", e2);
            }
        }
    }

    public final boolean R(e1 e1Var, boolean z) {
        c();
        r();
        r.k(e1Var);
        r.g(e1Var.U2());
        ...
        D0();
        long b = f().b();
        if (e1Var.u2() < b - wa.J() || e1Var.u2() > wa.J() + b) {
            i().H().d("Storing bundle outside of the max uploading time span. appId, now, timestamp", c4.w(e1Var.U2()), Long.valueOf(b), Long.valueOf(e1Var.u2()));
        }
        try {
            byte[] W = m().W(e1Var.i());
            i().M().b("Saving bundle, size", Integer.valueOf(W.length));
            ContentValues contentValues = new ContentValues();
            contentValues.put("app_id", e1Var.U2());
            contentValues.put("bundle_end_timestamp", Long.valueOf(e1Var.u2()));
            contentValues.put("data", W);
            contentValues.put("has_realtime", Integer.valueOf(z ? 1 : 0));
            if (e1Var.x0()) {
                contentValues.put("retry_count", Integer.valueOf(e1Var.I0()));
            }
            try {
                if (v().insert("queue", (String) null, contentValues) != -1) {
                    return true;
                }
                i().E().b("Failed to insert bundle (got -1). appId", c4.w(e1Var.U2()));
                return false;
            } catch (SQLiteException e2) {
                i().E().c("Error storing bundle. appId", c4.w(e1Var.U2()), e2);
                return false;
            }
        } catch (IOException e3) {
            i().E().c("Data loss. Failed to serialize bundle. appId", c4.w(e1Var.U2()), e3);
            return false;
        }
    }
    ...
    public final boolean S(l lVar, long j2, boolean z) {
        ...
        contentValues.put("timestamp", Long.valueOf(lVar.f2930d));
        ...
        try {
            ...
            i().E().b("Failed to insert raw event (got -1). appId", c4.w(lVar.a));
            return false;
        } catch (SQLiteException e2) {
            i().E().c("Error storing raw event. appId", c4.w(lVar.a), e2);
            return false;
        }
    }
    ...
    public final boolean T(ga gaVar) {
        ...
        if (o0(gaVar.a, gaVar.c) == null) {
            if (fa.d0(gaVar.c)) {
                if (i0("select count(1) from user_attributes where app_id=? and name not like '!_%' escape '!'", new String[]{gaVar.a}) >= ((long) l().y(gaVar.a))) {
                    return false;
                }
        ...
        contentValues.put("set_timestamp", Long.valueOf(gaVar.f2865d));
        M(contentValues, "value", gaVar.f2866e);
        try {
            if (v().insertWithOnConflict("user_attributes", (String) null, contentValues, 5) == -1) {
                i().E().b("Failed to insert/update user property (got -1). appId", c4.w(gaVar.a));
            }
        } catch (SQLiteException e2) {
            i().E().c("Error storing user property. appId", c4.w(gaVar.a), e2);
        }
        return true;
    }
    ...
    public final boolean U(ua uaVar) {
        ...
        c();
        r();
        if (o0(uaVar.f3163g, uaVar.f3165i.f2823h) == null) {
            if (i0("SELECT COUNT(1) FROM conditional_properties WHERE app_id=?", new String[]{uaVar.f3163g}) >= 1000) {
                return false;
            }
        }
        ContentValues contentValues = new ContentValues();
        contentValues.put("app_id", uaVar.f3163g);
        contentValues.put("origin", uaVar.f3164h);
        contentValues.put("name", uaVar.f3165i.f2823h);
        M(contentValues, "value", uaVar.f3165i.l());
        contentValues.put("active", Boolean.valueOf(uaVar.f3167k));
        contentValues.put("trigger_event_name", uaVar.f3168l);
        contentValues.put("trigger_timeout", Long.valueOf(uaVar.f3170n));
        g();
        contentValues.put("timed_out_event", fa.o0(uaVar.f3169m));
        contentValues.put("creation_timestamp", Long.valueOf(uaVar.f3166j));
        g();
        contentValues.put("triggered_event", fa.o0(uaVar.o));
        contentValues.put("triggered_timestamp", Long.valueOf(uaVar.f3165i.f2824i));
        contentValues.put("time_to_live", Long.valueOf(uaVar.p));
        g();
        contentValues.put("expired_event", fa.o0(uaVar.q));
        try {
            if (v().insertWithOnConflict("conditional_properties", (String) null, contentValues, 5) == -1) {
                i().E().b("Failed to insert/update conditional user property (got -1)", c4.w(uaVar.f3163g));
            }
        } catch (SQLiteException e2) {
            i().E().c("Error storing conditional user property", c4.w(uaVar.f3163g), e2);
        }
        return true;
    }
    ...
    public final boolean X(String str, Bundle bundle) {
        c();
        r();
        byte[] i2 = m().x(new l(this.a, "", str, "dep", 0, 0, bundle)).i();
        i().M().c("Saving default event parameters, appId, data size", e().v(str), Integer.valueOf(i2.length));
        ContentValues contentValues = new ContentValues();
        contentValues.put("app_id", str);
        ...
        try {
            ...
            i().E().b("Failed to insert default event parameters (got -1). appId", c4.w(str));
            return false;
        } catch (SQLiteException e2) {
            i().E().c("Error storing default event parameters. appId", c4.w(str), e2);
            return false;
        }
    }

    public final boolean Y(String str, Long l2, long j2, a1 a1Var) {
        c();
        r();
        r.k(a1Var);
        r.g(str);
        r.k(l2);
        byte[] i2 = a1Var.i();
        i().M().c("Saving complex main event, appId, data size", e().v(str), Integer.valueOf(i2.length));
        ContentValues contentValues = new ContentValues();
        contentValues.put("app_id", str);
        ...
        try {
            ...
            i().E().b("Failed to insert complex main event (got -1). appId", c4.w(str));
            return false;
        } catch (SQLiteException e2) {
            i().E().c("Error storing complex main event. appId", c4.w(str), e2);
            return false;
        }
    }
    ...
    public final com.google.android.gms.measurement.internal.f4 j0(java.lang.String r35) {
        /*
            r34 = this;
            r1 = r35
            com.google.android.gms.common.internal.r.g(r35)
            r34.c()
            r34.r()
            r2 = 0
        ...
        L_0x0124:
            ...
            com.google.android.gms.measurement.internal.wa r6 = r34.l()     // Catch:{ SQLiteException -> 0x0200 }
        ...
        L_0x01c5:
            boolean r0 = com.google.android.gms.internal.measurement.vc.a()     // Catch:{ SQLiteException -> 0x0200 }
            if (r0 == 0) goto L_0x01e0
            com.google.android.gms.measurement.internal.wa r0 = r34.l()     // Catch:{ SQLiteException -> 0x0200 }
        ...
        L_0x01e0:
            ...
            com.google.android.gms.measurement.internal.c4 r0 = r34.i()     // Catch:{ SQLiteException -> 0x0200 }
        ...
        L_0x020e:
            ...
            r3 = r2
        L_0x0212:
            com.google.android.gms.measurement.internal.c4 r4 = r34.i()     // Catch:{ all -> 0x0229 }
    ...
    public final void l0(String str, String str2) {
        ...
        try {
            ...
            i().E().d("Error deleting user property. appId", c4.w(str), e().z(str2), e2);
        }
    }
    ...
    public final long n0(String str) {
        ...
        r();
        try {
            return (long) v().delete("raw_events", "rowid in (select rowid from raw_events where app_id=? order by rowid desc limit -1 offset ?)", new String[]{str, String.valueOf(Math.max(0, Math.min(1000000, l().u(str, u.p))))});
        } catch (SQLiteException e2) {
            i().E().c("Error deleting over the limit events. appId", c4.w(str), e2);
            return 0;
        }
    }
    ...
    public final com.google.android.gms.measurement.internal.ga o0(java.lang.String r19, java.lang.String r20) {
        ...
        L_0x003f:
            ...
            com.google.android.gms.measurement.internal.c4 r1 = r18.i()     // Catch:{ SQLiteException -> 0x0074 }
        ...
        L_0x0082:
            ...
            r10 = r9
        L_0x0086:
            com.google.android.gms.measurement.internal.c4 r1 = r18.i()     // Catch:{ all -> 0x00a5 }
            ...
            com.google.android.gms.measurement.internal.a4 r4 = r18.e()     // Catch:{ all -> 0x00a5 }
    ...
    public final com.google.android.gms.measurement.internal.ua p0(java.lang.String r30, java.lang.String r31) {
        /*
            r29 = this;
            r7 = r31
            com.google.android.gms.common.internal.r.g(r30)
            com.google.android.gms.common.internal.r.g(r31)
            r29.c()
            r29.r()
            r8 = 0
        ...
        L_0x0063:
            ...
            com.google.android.gms.measurement.internal.ba r0 = r29.m()     // Catch:{ SQLiteException -> 0x00f0 }
            r1 = 5
            ...
            com.google.android.gms.measurement.internal.c4 r1 = r29.i()     // Catch:{ SQLiteException -> 0x00f0 }
            ...
            com.google.android.gms.measurement.internal.a4 r4 = r29.e()     // Catch:{ SQLiteException -> 0x00f0 }
        ...
        L_0x00fe:
            ...
            r9 = r8
        L_0x0102:
            com.google.android.gms.measurement.internal.c4 r1 = r29.i()     // Catch:{ all -> 0x0121 }
            ...
            com.google.android.gms.measurement.internal.a4 r4 = r29.e()     // Catch:{ all -> 0x0121 }
    ...
    public final byte[] q0(java.lang.String r11) {
        ...
        L_0x0031:
            ...
            com.google.android.gms.measurement.internal.c4 r3 = r10.i()     // Catch:{ SQLiteException -> 0x0052 }
        ...
        L_0x0056:
            ...
            r1 = r0
        L_0x0058:
            com.google.android.gms.measurement.internal.c4 r3 = r10.i()     // Catch:{ all -> 0x006f }
    ...
    public final int r0(String str, String str2) {
        ...
        try {
            ...
            i().E().d("Error deleting conditional property", c4.w(str), e().z(str2), e2);
            return 0;
        }
    }

    /* access modifiers changed from: package-private */
    public final Map<Integer, List<l0>> s0(String str) {
        r.g(str);
        a aVar = new a();
        Cursor cursor = null;
        try {
            ...
            if (!cursor.moveToFirst()) {
                Map<Integer, List<l0>> emptyMap = Collections.emptyMap();
                if (cursor != null) {
                    cursor.close();
                }
                return emptyMap;
            ...
            do {
                ...
                try {
                    ...
                    i().E().c("Failed to merge filter. appId", c4.w(str), e2);
                }
            ...
            i().E().c("Database error querying filters. appId", c4.w(str), e3);
            Map<Integer, List<l0>> emptyMap2 = Collections.emptyMap();
            if (cursor != null) {
                cursor.close();
            }
            return emptyMap2;
    ...
    public final java.util.Map<java.lang.Integer, java.util.List<java.lang.Integer>> u0(java.lang.String r8) {
        ...
        L_0x0069:
            ...
            r1 = r2
        L_0x006b:
            com.google.android.gms.measurement.internal.c4 r3 = r7.i()     // Catch:{ all -> 0x009e }
            ...
            boolean r0 = com.google.android.gms.internal.measurement.cc.a()     // Catch:{ all -> 0x009e }
            if (r0 == 0) goto L_0x0098
            com.google.android.gms.measurement.internal.wa r0 = r7.l()     // Catch:{ all -> 0x009e }
    ...
    public final SQLiteDatabase v() {
        c();
        try {
            return this.f2787d.getWritableDatabase();
        } catch (SQLiteException e2) {
            i().H().b("Error opening database", e2);
            throw e2;
        }
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final java.util.Map<java.lang.Integer, java.util.List<com.google.android.gms.internal.measurement.l0>> v0(java.lang.String r13, java.lang.String r14) {
        /*
            r12 = this;
            r12.r()
            r12.c()
        ...
        L_0x0042:
            ...
            com.google.android.gms.internal.measurement.l0$a r2 = com.google.android.gms.internal.measurement.l0.R()     // Catch:{ IOException -> 0x0077 }
            com.google.android.gms.measurement.internal.ba.z(r2, r1)     // Catch:{ IOException -> 0x0077 }
            com.google.android.gms.internal.measurement.l0$a r2 = (com.google.android.gms.internal.measurement.l0.a) r2     // Catch:{ IOException -> 0x0077 }
            com.google.android.gms.internal.measurement.j8 r1 = r2.l()     // Catch:{ IOException -> 0x0077 }
            com.google.android.gms.internal.measurement.z6 r1 = (com.google.android.gms.internal.measurement.z6) r1     // Catch:{ IOException -> 0x0077 }
            com.google.android.gms.internal.measurement.l0 r1 = (com.google.android.gms.internal.measurement.l0) r1     // Catch:{ IOException -> 0x0077 }
        ...
        L_0x0077:
            r1 = move-exception
            com.google.android.gms.measurement.internal.c4 r2 = r12.i()     // Catch:{ SQLiteException -> 0x0095 }
        ...
        L_0x0099:
            ...
            r14 = r9
        L_0x009b:
            com.google.android.gms.measurement.internal.c4 r1 = r12.i()     // Catch:{ all -> 0x00ce }
            ...
            boolean r0 = com.google.android.gms.internal.measurement.cc.a()     // Catch:{ all -> 0x00ce }
            if (r0 == 0) goto L_0x00c8
            com.google.android.gms.measurement.internal.wa r0 = r12.l()     // Catch:{ all -> 0x00ce }
    ...
    public final java.lang.String w() {
        ...
        L_0x0029:
            ...
            r0 = r1
        L_0x002b:
            com.google.android.gms.measurement.internal.c4 r3 = r6.i()     // Catch:{ all -> 0x003e }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final java.util.Map<java.lang.Integer, com.google.android.gms.internal.measurement.g1> w0(java.lang.String r12) {
        /*
            r11 = this;
            r11.r()
            r11.c()
            ...
            boolean r1 = com.google.android.gms.internal.measurement.cc.a()     // Catch:{ SQLiteException -> 0x0097 }
            if (r1 == 0) goto L_0x0049
            com.google.android.gms.measurement.internal.wa r1 = r11.l()     // Catch:{ SQLiteException -> 0x0097 }
        ...
        L_0x004e:
            return r8
        L_0x004f:
            e.e.a r1 = new e.e.a     // Catch:{ SQLiteException -> 0x0097 }
        ...
        L_0x0054:
            ...
            com.google.android.gms.internal.measurement.g1$a r4 = com.google.android.gms.internal.measurement.g1.a0()     // Catch:{ IOException -> 0x0075 }
            com.google.android.gms.measurement.internal.ba.z(r4, r3)     // Catch:{ IOException -> 0x0075 }
            com.google.android.gms.internal.measurement.g1$a r4 = (com.google.android.gms.internal.measurement.g1.a) r4     // Catch:{ IOException -> 0x0075 }
            com.google.android.gms.internal.measurement.j8 r3 = r4.l()     // Catch:{ IOException -> 0x0075 }
            com.google.android.gms.internal.measurement.z6 r3 = (com.google.android.gms.internal.measurement.z6) r3     // Catch:{ IOException -> 0x0075 }
            com.google.android.gms.internal.measurement.g1 r3 = (com.google.android.gms.internal.measurement.g1) r3     // Catch:{ IOException -> 0x0075 }
            java.lang.Integer r2 = java.lang.Integer.valueOf(r2)     // Catch:{ SQLiteException -> 0x0097 }
            r1.put(r2, r3)     // Catch:{ SQLiteException -> 0x0097 }
            goto L_0x008b
        L_0x0075:
            r3 = move-exception
            com.google.android.gms.measurement.internal.c4 r4 = r11.i()     // Catch:{ SQLiteException -> 0x0097 }
        ...
        L_0x009b:
            ...
            r0 = r8
        L_0x009d:
            com.google.android.gms.measurement.internal.c4 r2 = r11.i()     // Catch:{ all -> 0x00d0 }
            ...
            boolean r1 = com.google.android.gms.internal.measurement.cc.a()     // Catch:{ all -> 0x00d0 }
            if (r1 == 0) goto L_0x00ca
            com.google.android.gms.measurement.internal.wa r1 = r11.l()     // Catch:{ all -> 0x00d0 }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:45:0x00d2  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final java.util.Map<java.lang.Integer, java.util.List<com.google.android.gms.internal.measurement.o0>> x0(java.lang.String r13, java.lang.String r14) {
        /*
            r12 = this;
            r12.r()
            r12.c()
        ...
        L_0x0042:
            byte[] r1 = r14.getBlob(r11)     // Catch:{ SQLiteException -> 0x0095 }
            com.google.android.gms.internal.measurement.o0$a r2 = com.google.android.gms.internal.measurement.o0.L()     // Catch:{ IOException -> 0x0077 }
            com.google.android.gms.measurement.internal.ba.z(r2, r1)     // Catch:{ IOException -> 0x0077 }
            com.google.android.gms.internal.measurement.o0$a r2 = (com.google.android.gms.internal.measurement.o0.a) r2     // Catch:{ IOException -> 0x0077 }
            com.google.android.gms.internal.measurement.j8 r1 = r2.l()     // Catch:{ IOException -> 0x0077 }
            com.google.android.gms.internal.measurement.z6 r1 = (com.google.android.gms.internal.measurement.z6) r1     // Catch:{ IOException -> 0x0077 }
            com.google.android.gms.internal.measurement.o0 r1 = (com.google.android.gms.internal.measurement.o0) r1     // Catch:{ IOException -> 0x0077 }
            int r2 = r14.getInt(r10)     // Catch:{ SQLiteException -> 0x0095 }
            java.lang.Integer r3 = java.lang.Integer.valueOf(r2)     // Catch:{ SQLiteException -> 0x0095 }
            java.lang.Object r3 = r0.get(r3)     // Catch:{ SQLiteException -> 0x0095 }
            java.util.List r3 = (java.util.List) r3     // Catch:{ SQLiteException -> 0x0095 }
    ...
    public final long y(e1 e1Var) {
        ...
        try {
            ...
            i().E().c("Error storing raw event metadata. appId", c4.w(e1Var.U2()), e2);
            throw e2;
        }
    }
