...
public final class l6 extends f5 {
    ...
    private final Set<j6> f2943e = new CopyOnWriteArraySet();

    /* renamed from: f  reason: collision with root package name */
    private boolean f2944f;

    /* renamed from: g  reason: collision with root package name */
    private final AtomicReference<String> f2945g = new AtomicReference<>();

    /* renamed from: h  reason: collision with root package name */
    private final Object f2946h = new Object();

    /* renamed from: i  reason: collision with root package name */
    private e f2947i = new e((Boolean) null, (Boolean) null);

    /* renamed from: j  reason: collision with root package name */
    private int f2948j = 100;

    /* renamed from: k  reason: collision with root package name */
    private final AtomicLong f2949k = new AtomicLong(0);

    /* renamed from: l  reason: collision with root package name */
    private long f2950l = -1;

    /* renamed from: m  reason: collision with root package name */
    private int f2951m = 100;
    ...
    public final void K(e eVar, int i2, long j2, boolean z, boolean z2) {
        c();
        w();
        if (j2 <= this.f2950l && e.g(this.f2951m, i2)) {
            i().K().b("Dropped out-of-date consent setting, proposed settings", eVar);
        } else if (k().y(eVar, i2)) {
            this.f2950l = j2;
            this.f2951m = i2;
            r().U(z);
            ...
            i().K().b("Lower precedence consent source ignored, proposed source", Integer.valueOf(i2));
        }
    }
    ...
    public final void S(Boolean bool, boolean z) {
        c();
        w();
        i().L().b("Setting app measurement enabled (FE)", bool);
        k().u(bool);
        if (fb.a() && l().s(u.P0) && z) {
            k().z(bool);
        }
        if (!fb.a() || !l().s(u.P0) || this.a.r() || !bool.booleanValue()) {
            o0();
        }
    }

    private final void W(String str, String str2, long j2, Object obj) {
        a().y(new t6(this, str, str2, obj, j2));
    }
    ...
    public final void o0() {
        ...
        if (a != null) {
            if ("unset".equals(a)) {
                Z("app", "_npa", (Object) null, f().b());
            } else {
                Z("app", "_npa", Long.valueOf("true".equals(a) ? 1 : 0), f().b());
            }
        }
        if (!this.a.p() || !this.o) {
            i().L().a("Updating Scion state (FE)");
            r().W();
            return;
        }
        i().L().a("Recording app launch after enabling measurement for the first time (FE)");
        k0();
        if (jc.a() && l().s(u.s0)) {
            u().f2914d.a();
        }
        if (xb.a() && l().s(u.v0)) {
            if (!(this.a.D().a.x().f3031k.a() > 0)) {
                u4 D = this.a.D();
                D.b(D.a.j().getPackageName());
            }
        }
        if (l().s(u.L0)) {
            a().y(new p6(this));
    ...
    private final ArrayList<Bundle> p0(String str, String str2, String str3) {
        if (a().H()) {
            ...
            this.a.a().u(atomicReference, 5000, "get conditional user properties", new b7(this, atomicReference, str, str2, str3));
            List list = (List) atomicReference.get();
            if (list != null) {
                return fa.s0(list);
            }
            i().E().b("Timed out waiting for get conditional user properties", str);
    ...
    private final Map<String, Object> q0(String str, String str2, String str3, boolean z) {
        if (a().H()) {
            ...
            AtomicReference atomicReference = new AtomicReference();
            this.a.a().u(atomicReference, 5000, "get user properties", new a7(this, atomicReference, str, str2, str3, z));
    ...
    private final void s0(Bundle bundle, long j2) {
        ...
        r.g(bundle.getString("name"));
        r.g(bundle.getString("origin"));
        r.k(bundle.get("value"));
        bundle.putLong("creation_timestamp", j2);
        String string = bundle.getString("name");
        Object obj = bundle.get("value");
        if (g().p0(string) != 0) {
            i().E().b("Invalid conditional user property name", e().z(string));
        } else if (g().q0(string, obj) != 0) {
            i().E().c("Invalid conditional user property value", e().z(string), obj);
        } else {
            Object y0 = g().y0(string, obj);
            if (y0 == null) {
                i().E().c("Unable to normalize conditional user property value", e().z(string), obj);
                return;
            }
            f6.b(bundle, y0);
            ...
            if (TextUtils.isEmpty(bundle.getString("trigger_event_name")) || (j3 <= 15552000000L && j3 >= 1)) {
                ...
                if (j4 > 15552000000L || j4 < 1) {
                    i().E().c("Invalid conditional user property time to live", e().z(string), Long.valueOf(j4));
                } else {
                    a().y(new w6(this, bundle));
                }
            } else {
                i().E().c("Invalid conditional user property timeout", e().z(string), Long.valueOf(j3));
            }
        }
    }
    ...
    public final void x0(Bundle bundle) {
        ...
        w();
        r.k(bundle);
        r.g(bundle2.getString("name"));
        r.g(bundle2.getString("origin"));
        r.k(bundle2.get("value"));
        if (!this.a.p()) {
            i().M().a("Conditional property not set since app measurement is disabled");
            return;
        }
        try {
            r().P(new ua(bundle2.getString("app_id"), bundle2.getString("origin"), new ea(bundle2.getString("name"), bundle2.getLong("triggered_timestamp"), bundle2.get("value"), bundle2.getString("origin")), bundle2.getLong("creation_timestamp"), false, bundle2.getString("trigger_event_name"), g().E(bundle2.getString("app_id"), bundle2.getString("timed_out_event_name"), bundle2.getBundle("timed_out_event_params"), bundle2.getString("origin"), 0, true, false, ma.a() && l().s(u.S0)), bundle2.getLong("trigger_timeout"), g().E(bundle2.getString("app_id"), bundle2.getString("triggered_event_name"), bundle2.getBundle("triggered_event_params"), bundle2.getString("origin"), 0, true, false, ma.a() && l().s(u.S0)), bundle2.getLong("time_to_live"), g().E(bundle2.getString("app_id"), bundle2.getString("expired_event_name"), bundle2.getBundle("expired_event_params"), bundle2.getString("origin"), 0, true, false, ma.a() && l().s(u.S0))));
    ...
    public final void F(long j2, boolean z) {
        c();
        w();
        i().L().a("Resetting analytics data (FE)");
        j9 u = u();
        u.c();
        u.f2915e.a();
        boolean p = this.a.p();
    ...
    public final void H(Bundle bundle, long j2) {
        ...
        if (!TextUtils.isEmpty(bundle2.getString("app_id"))) {
            i().H().a("Package name should be null when calling setConditionalUserProperty");
        }
    ...
    public final void J(e eVar, int i2, long j2) {
        ...
        if (fb.a() && l().s(u.P0)) {
            ...
            if (eVar.l() == null && eVar.p() == null) {
                i().J().a("Discarding empty consent settings");
                return;
            }
            synchronized (this.f2946h) {
                ...
                z = true;
                z2 = false;
                if (e.g(i2, this.f2948j)) {
                    boolean h2 = eVar.h(this.f2947i);
                    if (eVar.q() && !this.f2947i.q()) {
                        z2 = true;
                    }
                    eVar2 = eVar.n(this.f2947i);
                    this.f2947i = eVar2;
                    z3 = z2;
                    z2 = h2;
                } else {
            ...
            if (!z) {
                i().K().b("Ignoring lower-priority consent settings, proposed settings", eVar2);
                return;
            }
            long andIncrement = this.f2949k.getAndIncrement();
            if (z2) {
                T((String) null);
                a().B(new i7(this, eVar2, j2, i2, andIncrement, z3));
                return;
            }
            a().y(new h7(this, eVar2, i2, andIncrement, z3));
        }
    }
    ...
    public final void L(j6 j6Var) {
        w();
        r.k(j6Var);
        if (!this.f2943e.add(j6Var)) {
            i().H().a("OnEventListener already registered");
        }
    }
    ...
    public final void M(k6 k6Var) {
        ...
        c();
        w();
        if (!(k6Var == null || k6Var == (k6Var2 = this.f2942d))) {
            r.o(k6Var2 == null, "EventInterceptor already set.");
        }
        this.f2942d = k6Var;
    }
    ...
    public final void U(String str, String str2, long j2, Bundle bundle) {
        c();
        V(str, str2, j2, bundle, true, this.f2942d == null || fa.C0(str2), false, (String) null);
    }
    ...
    public final void V(java.lang.String r28, java.lang.String r29, long r30, android.os.Bundle r32, boolean r33, boolean r34, boolean r35, java.lang.String r36) {
        /*
            ...
            com.google.android.gms.common.internal.r.g(r28)
            com.google.android.gms.common.internal.r.k(r32)
            r27.c()
            r27.w()
            com.google.android.gms.measurement.internal.h5 r1 = r7.a
            boolean r1 = r1.p()
            if (r1 != 0) goto L_0x002e
            com.google.android.gms.measurement.internal.c4 r0 = r27.i()
        ...
        L_0x004c:
            ...
            android.content.Context r1 = r27.j()     // Catch:{ ClassNotFoundException -> 0x0095 }
        ...
        L_0x006e:
            ...
            android.content.Context r2 = r27.j()     // Catch:{ Exception -> 0x0086 }
            r1[r10] = r2     // Catch:{ Exception -> 0x0086 }
            r0.invoke(r11, r1)     // Catch:{ Exception -> 0x0086 }
            goto L_0x00a2
        L_0x0086:
            r0 = move-exception
            com.google.android.gms.measurement.internal.c4 r1 = r27.i()     // Catch:{ ClassNotFoundException -> 0x0095 }
        ...
        L_0x0095:
            ...
            r0.a(r1)
        L_0x00a2:
            com.google.android.gms.measurement.internal.wa r0 = r27.l()
            ...
            com.google.android.gms.common.util.e r0 = r27.f()
            long r5 = r0.b()
            ...
            r1.Z(r2, r3, r4, r5)
        L_0x00d3:
            boolean r0 = com.google.android.gms.internal.measurement.wc.a()
            ...
            com.google.android.gms.measurement.internal.p4 r1 = r27.k()
        ...
        L_0x00fe:
            ...
            boolean r2 = com.google.android.gms.internal.measurement.ma.a()
            if (r2 == 0) goto L_0x0124
            com.google.android.gms.measurement.internal.wa r2 = r27.l()
        ...
        L_0x0150:
            ...
            com.google.android.gms.measurement.internal.c4 r1 = r27.i()
            com.google.android.gms.measurement.internal.e4 r1 = r1.G()
            com.google.android.gms.measurement.internal.a4 r2 = r27.e()
        ...
        L_0x019d:
            ...
            com.google.android.gms.measurement.internal.k6 r4 = r7.f2942d
            if (r4 == 0) goto L_0x01df
            if (r3 != 0) goto L_0x01df
            if (r16 != 0) goto L_0x01df
            com.google.android.gms.measurement.internal.c4 r0 = r27.i()
            com.google.android.gms.measurement.internal.e4 r0 = r0.L()
            com.google.android.gms.measurement.internal.a4 r1 = r27.e()
            java.lang.String r1 = r1.v(r15)
            com.google.android.gms.measurement.internal.a4 r2 = r27.e()
            java.lang.String r2 = r2.t(r12)
            java.lang.String r3 = "Passing event to registered event handler (FE)"
            r0.c(r3, r1, r2)
            com.google.android.gms.measurement.internal.k6 r1 = r7.f2942d
            r2 = r28
            r3 = r29
            r4 = r32
            r5 = r30
        ...
        L_0x01e8:
            ...
            boolean r4 = com.google.android.gms.internal.measurement.ma.a()
            if (r4 == 0) goto L_0x0200
            com.google.android.gms.measurement.internal.wa r4 = r27.l()
        ...
        L_0x0241:
            ...
            java.util.List r17 = com.google.android.gms.common.util.f.d(r5)
        ...
        L_0x0296:
            r14 = r11
        L_0x0297:
            com.google.android.gms.measurement.internal.wa r1 = r27.l()
            ...
            com.google.android.gms.measurement.internal.p9 r1 = r1.f2915e
            long r1 = r1.e()
        ...
        L_0x02cf:
            r12 = r29
        L_0x02d1:
            boolean r1 = com.google.android.gms.internal.measurement.rb.a()
            ...
            java.lang.String r2 = r15.getString(r2)
            boolean r3 = com.google.android.gms.common.util.n.a(r2)
        ...
        L_0x030a:
            com.google.android.gms.measurement.internal.p4 r2 = r1.k()
            ...
            goto L_0x0333
        L_0x0329:
            com.google.android.gms.measurement.internal.p4 r1 = r1.k()
        ...
        L_0x0353:
            ...
            r1.a(r2)
            r6 = 0
            com.google.android.gms.common.util.e r1 = r27.f()
            long r19 = r1.b()
            java.lang.String r2 = "auto"
        ...
        L_0x03db:
            ...
            com.google.android.gms.measurement.internal.r9 r1 = r1.f2914d
            r5 = 1
            r1.b(r9, r5)
            goto L_0x0404
        L_0x0403:
        ...
        L_0x0537:
            ...
            java.util.Set<com.google.android.gms.measurement.internal.j6> r1 = r12.f2943e
    ...
    public final void Y(String str, String str2, Bundle bundle, boolean z, boolean z2, long j2) {
        ...
        long j3 = j2;
        a().y(new u6(this, str3, str2, j2, fa.r0(bundle2), z2, !z2 || this.f2942d == null || fa.C0(str2), !z, (String) null));
    }
    ...
    public final void Z(java.lang.String r9, java.lang.String r10, java.lang.Object r11, long r12) {
        ...
        L_0x0037:
            ...
            com.google.android.gms.measurement.internal.p4 r0 = r8.k()
        ...
        L_0x0050:
            ...
            com.google.android.gms.measurement.internal.p4 r10 = r8.k()
        ...
        L_0x0062:
            ...
            com.google.android.gms.measurement.internal.c4 r9 = r8.i()
    ...
    public final Boolean e0() {
        AtomicReference atomicReference = new AtomicReference();
        return (Boolean) a().u(atomicReference, 15000, "boolean test flag value", new q6(this, atomicReference));
    }

    public final String f0() {
        AtomicReference atomicReference = new AtomicReference();
        return (String) a().u(atomicReference, 15000, "String test flag value", new z6(this, atomicReference));
    }

    public final Long g0() {
        AtomicReference atomicReference = new AtomicReference();
        return (Long) a().u(atomicReference, 15000, "long test flag value", new d7(this, atomicReference));
    }

    public final Integer h0() {
        AtomicReference atomicReference = new AtomicReference();
        return (Integer) a().u(atomicReference, 15000, "int test flag value", new c7(this, atomicReference));
    }

    public final Double i0() {
        AtomicReference atomicReference = new AtomicReference();
        return (Double) a().u(atomicReference, 15000, "double test flag value", new f7(this, atomicReference));
    }
        ...
        if (this.a.u()) {
            if (l().s(u.e0)) {
                ...
                if (D != null && D.booleanValue()) {
                    i().L().a("Deferred Deep Link feature enabled.");
                    a().y(new n6(this));
                }
            }
            r().Y();
    ...
    public final String n0() {
        ...
        try {
            return r7.a(j(), "google_app_id");
        } catch (IllegalStateException e2) {
            this.a.i().E().b("getGoogleAppId failed with exception", e2);
            return null;
        }
    }
    ...
    public final void t0(j6 j6Var) {
        w();
        r.k(j6Var);
        if (!this.f2943e.remove(j6Var)) {
            i().H().a("OnEventListener had not been registered");
        }
    }
