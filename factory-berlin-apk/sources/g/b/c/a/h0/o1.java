...
/* compiled from: RsaSsaPssPublicKey */
public final class o1 extends y<o1, b> implements Object {
    ...
    private static volatile z0<o1> PARSER = null;
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: g.b.c.a.h0.o1.a.<clinit>():void");
        }
    }
    ...
    public static final class b extends y.a<o1, b> implements Object {
        ...
        public b D(i iVar) {
            x();
            ((o1) this.f3843h).Y(iVar);
            return this;
        }

        public b E(i iVar) {
            x();
            ((o1) this.f3843h).Z(iVar);
            return this;
        }

        public b F(m1 m1Var) {
            x();
            ((o1) this.f3843h).a0(m1Var);
            return this;
        }

        public b G(int i2) {
            x();
            ((o1) this.f3843h).b0(i2);
            return this;
        }
    ...
    public static o1 X(i iVar, p pVar) {
        return (o1) y.E(DEFAULT_INSTANCE, iVar, pVar);
    }
