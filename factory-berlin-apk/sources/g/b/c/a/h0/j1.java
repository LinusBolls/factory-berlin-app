...
/* compiled from: RsaSsaPkcs1PrivateKey */
public final class j1 extends y<j1, b> implements Object {
    ...
    private static volatile z0<j1> PARSER = null;
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: g.b.c.a.h0.j1.a.<clinit>():void");
        }
    }
    ...
    public static final class b extends y.a<j1, b> implements Object {
        ...
        public b D(i iVar) {
            x();
            ((j1) this.f3843h).f0(iVar);
            return this;
        }

        public b E(i iVar) {
            x();
            ((j1) this.f3843h).g0(iVar);
            return this;
        }

        public b F(i iVar) {
            x();
            ((j1) this.f3843h).h0(iVar);
            return this;
        }

        public b G(i iVar) {
            x();
            ((j1) this.f3843h).i0(iVar);
            return this;
        }

        public b H(i iVar) {
            x();
            ((j1) this.f3843h).j0(iVar);
            return this;
        }

        public b I(k1 k1Var) {
            x();
            ((j1) this.f3843h).k0(k1Var);
            return this;
        }

        public b J(i iVar) {
            x();
            ((j1) this.f3843h).l0(iVar);
            return this;
        }

        public b M(int i2) {
            x();
            ((j1) this.f3843h).m0(i2);
            return this;
        }
    ...
    public static j1 e0(i iVar, p pVar) {
        return (j1) y.E(DEFAULT_INSTANCE, iVar, pVar);
    }
