...
public final class f extends y<f, b> implements Object {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: g.b.c.a.h0.f.a.<clinit>():void");
        }
    }
    ...
    public static final class b extends y.a<f, b> implements Object {
        ...
        public b D(i iVar) {
            x();
            ((f) this.f3843h).V(iVar);
            return this;
        }

        public b E(h hVar) {
            x();
            ((f) this.f3843h).W(hVar);
            return this;
        }
    ...
    public static f U(i iVar, p pVar) {
        return (f) y.E(DEFAULT_INSTANCE, iVar, pVar);
    }
