...
public final class n0 extends y<n0, b> implements Object {
    ...
    private static volatile z0<n0> PARSER;
    private i encryptedKeyset_ = i.f3733h;
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: g.b.c.a.h0.n0.a.<clinit>():void");
        }
    }
    ...
    public static final class b extends y.a<n0, b> implements Object {
        ...
        public b D(i iVar) {
            x();
            ((n0) this.f3843h).S(iVar);
            return this;
        }

        public b E(a1 a1Var) {
            x();
            ((n0) this.f3843h).T(a1Var);
            return this;
        }
    ...
    public static n0 R(byte[] bArr, p pVar) {
        return (n0) y.F(DEFAULT_INSTANCE, bArr, pVar);
    }
