...
/* compiled from: ChaCha20Base */
abstract class l implements g0 {
    ...
    private void h(byte[] bArr, ByteBuffer byteBuffer, ByteBuffer byteBuffer2) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            ...
            if (i3 == i2 - 1) {
                j.c(byteBuffer, byteBuffer2, c2, remaining % 64);
            } else {
                j.c(byteBuffer, byteBuffer2, c2, 64);
            }
        }
    }
    ...
    static void k(int[] iArr, int[] iArr2) {
        ...
        System.arraycopy(iArr2, 0, iArr, c.length, 8);
    }
