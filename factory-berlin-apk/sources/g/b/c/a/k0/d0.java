...
final class d0 {
    ...
    private static final int[] f9642d = {26, 25};
    ...
    static byte[] a(long[] jArr) {
        ...
        for (int i8 = 0; i8 < 2; i8++) {
            ...
            while (i9 < 9) {
                int i10 = i9 & 1;
                int i11 = (int) (copyOf[i9] >> f9642d[i10]);
        ...
        for (int i12 = 1; i12 < 10; i12++) {
            d2 &= b((int) copyOf[i12], c[i12 & 1]);
        }
        copyOf[0] = copyOf[0] - ((long) (67108845 & d2));
        long j3 = (long) (33554431 & d2);
        copyOf[1] = copyOf[1] - j3;
        for (int i13 = 2; i13 < 10; i13 += 2) {
            copyOf[i13] = copyOf[i13] - ((long) (67108863 & d2));
            int i14 = i13 + 1;
            copyOf[i14] = copyOf[i14] - j3;
        }
        for (int i15 = 0; i15 < 10; i15++) {
            copyOf[i15] = copyOf[i15] << b[i15];
        }
        byte[] bArr = new byte[32];
        for (int i16 = 0; i16 < 10; i16++) {
            int[] iArr2 = a;
            int i17 = iArr2[i16];
            bArr[i17] = (byte) ((int) (((long) bArr[i17]) | (copyOf[i16] & 255)));
            int i18 = iArr2[i16] + 1;
            bArr[i18] = (byte) ((int) (((long) bArr[i18]) | ((copyOf[i16] >> 8) & 255)));
            int i19 = iArr2[i16] + 2;
            bArr[i19] = (byte) ((int) (((long) bArr[i19]) | ((copyOf[i16] >> 16) & 255)));
            int i20 = iArr2[i16] + 3;
            bArr[i20] = (byte) ((int) (((long) bArr[i20]) | ((copyOf[i16] >> 24) & 255)));
        }
        return bArr;
    }
    ...
    static long[] c(byte[] bArr) {
        ...
        for (int i2 = 0; i2 < 10; i2++) {
            int[] iArr = a;
            jArr[i2] = ((((((long) (bArr[iArr[i2]] & 255)) | (((long) (bArr[iArr[i2] + 1] & 255)) << 8)) | (((long) (bArr[iArr[i2] + 2] & 255)) << 16)) | (((long) (bArr[iArr[i2] + 3] & 255)) << 24)) >> b[i2]) & ((long) c[i2 & 1]);
        }
        return jArr;
    }
    ...
    static void g(long[] r18, long[] r19, long[] r20) {
        /*
            r0 = 0
            r1 = r19[r0]
            r3 = r20[r0]
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: g.b.c.a.k0.d0.g(long[], long[], long[]):void");
    }
    ...
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static void l(long[] r23, long[] r24) {
        /*
            r0 = 0
            r1 = r24[r0]
            r3 = r24[r0]
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: g.b.c.a.k0.d0.l(long[], long[]):void");
    }
    ...
    static void n(long[] jArr, long[] jArr2) {
        o(jArr, jArr, jArr2);
    }

    static void o(long[] jArr, long[] jArr2, long[] jArr3) {
        for (int i2 = 0; i2 < 10; i2++) {
            jArr[i2] = jArr2[i2] + jArr3[i2];
        }
    }
