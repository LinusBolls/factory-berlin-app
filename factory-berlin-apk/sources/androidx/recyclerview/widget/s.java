...
class s {
    ...
    private void c(List<a.b> list, int i2, a.b bVar, int i3, a.b bVar2) {
        int i4 = bVar.f1239d < bVar2.b ? -1 : 0;
        if (bVar.b < bVar2.b) {
            i4++;
        }
        int i5 = bVar2.b;
        int i6 = bVar.b;
        if (i5 <= i6) {
            bVar.b = i6 + bVar2.f1239d;
        }
        int i7 = bVar2.b;
        int i8 = bVar.f1239d;
        if (i7 <= i8) {
            bVar.f1239d = i8 + bVar2.f1239d;
        }
        bVar2.b += i4;
        list.set(i2, bVar2);
        list.set(i3, bVar);
    ...
    public void e(java.util.List<androidx.recyclerview.widget.a.b> r10, int r11, androidx.recyclerview.widget.a.b r12, int r13, androidx.recyclerview.widget.a.b r14) {
        ...
        L_0x002f:
            ...
            r10.remove(r13)
            androidx.recyclerview.widget.s$a r10 = r9.a
            r10.a(r14)
        L_0x0047:
            return
        L_0x0048:
        ...
        L_0x0053:
            ...
            int r4 = r4 + r7
            int r4 = r4 - r1
            androidx.recyclerview.widget.s$a r7 = r9.a
            int r1 = r1 + r3
        ...
        L_0x00eb:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.recyclerview.widget.s.e(java.util.List, int, androidx.recyclerview.widget.a$b, int, androidx.recyclerview.widget.a$b):void");
    }
    ...
    public void f(java.util.List<androidx.recyclerview.widget.a.b> r9, int r10, androidx.recyclerview.widget.a.b r11, int r12, androidx.recyclerview.widget.a.b r13) {
        ...
        L_0x000d:
            ...
            int r5 = r5 - r4
            r13.f1239d = r5
            androidx.recyclerview.widget.s$a r0 = r8.a
            int r1 = r11.b
        ...
        L_0x002b:
            ...
            int r5 = r5 + r6
            int r5 = r5 - r1
            androidx.recyclerview.widget.s$a r3 = r8.a
            int r1 = r1 + r4
        ...
        L_0x004c:
            r9.remove(r10)
            androidx.recyclerview.widget.s$a r11 = r8.a
            r11.a(r13)
        L_0x0054:
