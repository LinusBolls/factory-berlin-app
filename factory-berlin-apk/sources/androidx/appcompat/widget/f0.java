...
class f0 extends ListView {
    ...
    private final Rect f409g = new Rect();
    ...
    private void a() {
        ...
        View childAt = getChildAt(this.f414l - getFirstVisiblePosition());
        if (childAt != null) {
    ...
    private void c(Canvas canvas) {
        Drawable selector;
        if (!this.f409g.isEmpty() && (selector = getSelector()) != null) {
            selector.setBounds(this.f409g);
            selector.draw(canvas);
        }
    }

    private void f(int i2, View view) {
        Rect rect = this.f409g;
        rect.set(view.getLeft(), view.getTop(), view.getRight(), view.getBottom());
        rect.left -= this.f410h;
        rect.top -= this.f411i;
        rect.right += this.f412j;
        rect.bottom += this.f413k;
        try {
            boolean z = this.f415m.getBoolean(this);
            if (view.isEnabled() != z) {
                this.f415m.set(this, Boolean.valueOf(!z));
                if (i2 != -1) {
    ...
    public boolean e(android.view.MotionEvent r8, int r9) {
        ...
        L_0x004d:
            ...
            androidx.core.widget.f r9 = r7.s
        ...
        L_0x005a:
            ...
            goto L_0x006c
        L_0x0065:
            androidx.core.widget.f r8 = r7.s
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            this.f414l = pointToPosition((int) motionEvent.getX(), (int) motionEvent.getY());
        }
        b bVar = this.t;
        if (bVar != null) {
            bVar.a();
    ...
    public void setSelector(Drawable drawable) {
        ...
        this.f410h = rect.left;
        this.f411i = rect.top;
        this.f412j = rect.right;
        this.f413k = rect.bottom;
    }
}
