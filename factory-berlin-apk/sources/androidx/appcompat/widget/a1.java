...
class a1 {
    ...
    private final WindowManager.LayoutParams f389d = new WindowManager.LayoutParams();

    /* renamed from: e  reason: collision with root package name */
    private final Rect f390e = new Rect();

    /* renamed from: f  reason: collision with root package name */
    private final int[] f391f = new int[2];

    /* renamed from: g  reason: collision with root package name */
    private final int[] f392g = new int[2];
    ...
    a1(Context context) {
        ...
        this.f389d.setTitle(a1.class.getSimpleName());
        this.f389d.packageName = this.a.getPackageName();
        WindowManager.LayoutParams layoutParams = this.f389d;
    ...
    private void a(View view, int i2, int i3, boolean z, WindowManager.LayoutParams layoutParams) {
        ...
        b2.getWindowVisibleDisplayFrame(this.f390e);
        ...
        if (rect.left < 0 && rect.top < 0) {
            ...
            this.f390e.set(0, dimensionPixelSize, displayMetrics.widthPixels, displayMetrics.heightPixels);
        }
        b2.getLocationOnScreen(this.f392g);
        view.getLocationOnScreen(this.f391f);
        int[] iArr = this.f391f;
        int i6 = iArr[0];
        ...
        } else if (measuredHeight + i8 <= this.f390e.height()) {
            layoutParams.y = i8;
        } else {
            layoutParams.y = i7;
        }
    ...
    public void e(View view, int i2, int i3, boolean z, CharSequence charSequence) {
        ...
        a(view, i2, i3, z, this.f389d);
        ((WindowManager) this.a.getSystemService("window")).addView(this.b, this.f389d);
    }
}
