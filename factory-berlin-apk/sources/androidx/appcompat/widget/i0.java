...
public class i0 extends ViewGroup {
    ...
    private void k(int i2, int i3) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            if (s2.getVisibility() != 8) {
                ...
                if (aVar.height == -1) {
                    int i5 = aVar.width;
                    aVar.width = s2.getMeasuredWidth();
    ...
    private void l(int i2, int i3) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            if (s2.getVisibility() != 8) {
                ...
                if (aVar.width == -1) {
                    int i5 = aVar.height;
                    aVar.height = s2.getMeasuredHeight();
    ...
    public void g(Canvas canvas) {
        ...
        for (int i6 = 0; i6 < virtualChildCount; i6++) {
            View s2 = s(i6);
            if (!(s2 == null || s2.getVisibility() == 8 || !t(i6))) {
                a aVar = (a) s2.getLayoutParams();
                if (b) {
                    i5 = s2.getRight() + aVar.rightMargin;
                } else {
                    i5 = (s2.getLeft() - aVar.leftMargin) - this.r;
                }
                j(canvas, i5);
            }
        }
        if (t(virtualChildCount)) {
            ...
            if (s3 != null) {
                a aVar2 = (a) s3.getLayoutParams();
                if (b) {
                    i4 = s3.getLeft() - aVar2.leftMargin;
                    i3 = this.r;
                } else {
                    i2 = s3.getRight() + aVar2.rightMargin;
                    j(canvas, i2);
                }
            } else if (b) {
                i2 = getPaddingLeft();
    ...
    public int getBaseline() {
        ...
        if (childCount > i3) {
            ...
            if (baseline != -1) {
                int i4 = this.f439i;
                if (this.f440j == 1 && (i2 = this.f441k & 112) != 48) {
                    if (i2 == 16) {
                        i4 += ((((getBottom() - getTop()) - getPaddingTop()) - getPaddingBottom()) - this.f442l) / 2;
                    } else if (i2 == 80) {
                        i4 = ((getBottom() - getTop()) - getPaddingBottom()) - this.f442l;
                    }
                }
                return i4 + ((a) childAt.getLayoutParams()).topMargin + baseline;
            } else if (this.f438h == 0) {
                return -1;
            } else {
    ...
    public void h(Canvas canvas) {
        ...
        for (int i3 = 0; i3 < virtualChildCount; i3++) {
            View s2 = s(i3);
            if (!(s2 == null || s2.getVisibility() == 8 || !t(i3))) {
                i(canvas, (s2.getTop() - ((a) s2.getLayoutParams()).topMargin) - this.s);
            }
        }
        if (t(virtualChildCount)) {
            View s3 = s(virtualChildCount - 1);
            if (s3 == null) {
                i2 = (getHeight() - getPaddingBottom()) - this.s;
            } else {
                i2 = s3.getBottom() + ((a) s3.getLayoutParams()).bottomMargin;
            }
            i(canvas, i2);
        }
    }
    ...
    public void setVerticalGravity(int i2) {
        ...
        int i4 = this.f441k;
        if ((i4 & 112) != i3) {
            this.f441k = i3 | (i4 & -113);
            requestLayout();
        }
    }

    public void setWeightSum(float f2) {
        this.f443m = Math.max(0.0f, f2);
    }
    ...
    public void u(int r25, int r26, int r27, int r28) {
        /*
            ...
            boolean r12 = r6.f437g
            int[] r13 = r6.o
            int[] r14 = r6.p
            int r1 = e.h.k.u.x(r24)
            int r1 = e.h.k.e.b(r2, r1)
            r15 = 2
            r5 = 1
    ...
    public void v(int r18, int r19, int r20, int r21) {
        ...
        L_0x0059:
            ...
            r1 = r11
        L_0x0075:
            int r2 = e.h.k.u.x(r17)
            int r1 = e.h.k.e.b(r1, r2)
            r1 = r1 & 7
    ...
    public i0(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.f439i = 0;
        this.f441k = 8388659;
        w0 u2 = w0.u(context, attributeSet, j.LinearLayoutCompat, i2, 0);
        int k2 = u2.k(j.LinearLayoutCompat_android_orientation, -1);
        if (k2 >= 0) {
            setOrientation(k2);
        }
        int k3 = u2.k(j.LinearLayoutCompat_android_gravity, -1);
        if (k3 >= 0) {
            setGravity(k3);
        }
        boolean a2 = u2.a(j.LinearLayoutCompat_android_baselineAligned, true);
        if (!a2) {
            setBaselineAligned(a2);
        }
        this.f443m = u2.i(j.LinearLayoutCompat_android_weightSum, -1.0f);
        this.f438h = u2.k(j.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.f444n = u2.a(j.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(u2.g(j.LinearLayoutCompat_divider));
        this.t = u2.k(j.LinearLayoutCompat_showDividers, 0);
        this.u = u2.f(j.LinearLayoutCompat_dividerPadding, 0);
        u2.v();
    }
