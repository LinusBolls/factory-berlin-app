...
public class ConstraintLayout extends ViewGroup {
    ...
    SparseArray<View> f583g = new SparseArray<>();

    /* renamed from: h  reason: collision with root package name */
    private ArrayList<a> f584h = new ArrayList<>(4);

    /* renamed from: i  reason: collision with root package name */
    private final ArrayList<f> f585i = new ArrayList<>(100);
    ...
    private int f589m = Integer.MAX_VALUE;

    /* renamed from: n  reason: collision with root package name */
    private int f590n = Integer.MAX_VALUE;
        ...
        if (attributeSet != null) {
            ...
            for (int i2 = 0; i2 < indexCount; i2++) {
                ...
                if (index == f.ConstraintLayout_Layout_android_minWidth) {
                    this.f587k = obtainStyledAttributes.getDimensionPixelOffset(index, this.f587k);
                } else if (index == f.ConstraintLayout_Layout_android_minHeight) {
                    this.f588l = obtainStyledAttributes.getDimensionPixelOffset(index, this.f588l);
                } else if (index == f.ConstraintLayout_Layout_android_maxWidth) {
                    this.f589m = obtainStyledAttributes.getDimensionPixelOffset(index, this.f589m);
                } else if (index == f.ConstraintLayout_Layout_android_maxHeight) {
                    this.f590n = obtainStyledAttributes.getDimensionPixelOffset(index, this.f590n);
    ...
    private void i(int r24, int r25) {
        ...
        L_0x0103:
            ...
            goto L_0x02cf
        L_0x0114:
            e.f.a.j.e$d r14 = e.f.a.j.e.d.LEFT
            e.f.a.j.e r14 = r7.h(r14)
            e.f.a.j.l r14 = r14.f()
            e.f.a.j.e$d r15 = e.f.a.j.e.d.RIGHT
            e.f.a.j.e r15 = r7.h(r15)
            e.f.a.j.l r15 = r15.f()
            e.f.a.j.e$d r10 = e.f.a.j.e.d.LEFT
            e.f.a.j.e r10 = r7.h(r10)
            e.f.a.j.e r10 = r10.i()
            if (r10 == 0) goto L_0x0142
            e.f.a.j.e$d r10 = e.f.a.j.e.d.RIGHT
            e.f.a.j.e r10 = r7.h(r10)
            e.f.a.j.e r10 = r10.i()
            if (r10 == 0) goto L_0x0142
            r10 = 1
        ...
        L_0x0142:
            r10 = 0
        L_0x0143:
            e.f.a.j.e$d r8 = e.f.a.j.e.d.TOP
            e.f.a.j.e r8 = r7.h(r8)
            e.f.a.j.l r8 = r8.f()
            e.f.a.j.e$d r9 = e.f.a.j.e.d.BOTTOM
            e.f.a.j.e r9 = r7.h(r9)
            e.f.a.j.l r9 = r9.f()
            r17 = r5
            e.f.a.j.e$d r5 = e.f.a.j.e.d.TOP
            e.f.a.j.e r5 = r7.h(r5)
            e.f.a.j.e r5 = r5.i()
        ...
        L_0x0187:
            ...
            e.f.a.j.f$b r2 = r2.s()
            r21 = r6
            e.f.a.j.f$b r6 = e.f.a.j.f.b.WRAP_CONTENT
        ...
        L_0x0197:
            r2 = 0
        L_0x0198:
            e.f.a.j.g r6 = r0.f586j
            e.f.a.j.f$b r6 = r6.B()
            e.f.a.j.f$b r0 = e.f.a.j.f.b.WRAP_CONTENT
    ...
    private void j() {
        ...
        L_0x000f:
            ...
            r0.k(r3, r7, r8)     // Catch:{ NotFoundException -> 0x0045 }
            r8 = 47
        ...
        L_0x003a:
            ...
            e.f.a.j.f r6 = r0.d(r6)     // Catch:{ NotFoundException -> 0x0045 }
        ...
        L_0x0061:
            ...
            boolean r7 = r6 instanceof androidx.constraintlayout.widget.c
            if (r7 == 0) goto L_0x007b
            androidx.constraintlayout.widget.c r6 = (androidx.constraintlayout.widget.c) r6
        ...
        L_0x007b:
            ...
            goto L_0x0061
        L_0x007e:
            androidx.constraintlayout.widget.b r5 = r0.q
            if (r5 == 0) goto L_0x0085
            r5.a(r0)
        L_0x0085:
            e.f.a.j.g r5 = r0.f586j
            r5.M0()
            java.util.ArrayList<androidx.constraintlayout.widget.a> r5 = r0.f584h
            int r5 = r5.size()
            if (r5 <= 0) goto L_0x00a3
            r6 = 0
        L_0x0093:
            if (r6 >= r5) goto L_0x00a3
            java.util.ArrayList<androidx.constraintlayout.widget.a> r7 = r0.f584h
        ...
        L_0x00d6:
            ...
            r0.k(r3, r7, r8)     // Catch:{ NotFoundException -> 0x0107 }
            ...
            int r8 = r6.getId()     // Catch:{ NotFoundException -> 0x0107 }
            e.f.a.j.f r8 = r0.d(r8)     // Catch:{ NotFoundException -> 0x0107 }
        ...
        L_0x0128:
            java.util.ArrayList<e.f.a.j.f> r6 = r0.f585i
            r6.add(r13)
        L_0x012d:
            boolean r6 = r14.X
            r7 = 17
            if (r6 == 0) goto L_0x015e
            e.f.a.j.i r13 = (e.f.a.j.i) r13
            int r6 = r14.h0
            int r8 = r14.i0
            float r9 = r14.j0
        ...
        L_0x022a:
            ...
            e.f.a.j.f r9 = r0.d(r8)
            if (r9 == 0) goto L_0x023e
            e.f.a.j.e$d r8 = e.f.a.j.e.d.LEFT
            e.f.a.j.e$d r10 = e.f.a.j.e.d.RIGHT
        ...
        L_0x023e:
            ...
            e.f.a.j.f r9 = r0.d(r3)
            if (r9 == 0) goto L_0x0266
            e.f.a.j.e$d r8 = e.f.a.j.e.d.RIGHT
            e.f.a.j.e$d r10 = e.f.a.j.e.d.LEFT
        ...
        L_0x0266:
            ...
            e.f.a.j.e$d r10 = e.f.a.j.e.d.TOP
        ...
        L_0x027c:
            ...
            if (r9 == 0) goto L_0x0292
            e.f.a.j.e$d r8 = e.f.a.j.e.d.TOP
            e.f.a.j.e$d r10 = e.f.a.j.e.d.BOTTOM
            int r11 = r14.topMargin
            int r12 = r14.u
            r7 = r13
            r7.J(r8, r9, r10, r11, r12)
        L_0x0292:
            ...
            e.f.a.j.e$d r8 = e.f.a.j.e.d.BOTTOM
            e.f.a.j.e$d r10 = e.f.a.j.e.d.TOP
        ...
        L_0x02be:
            ...
            android.util.SparseArray<android.view.View> r6 = r0.f583g
            java.lang.Object r3 = r6.get(r3)
            android.view.View r3 = (android.view.View) r3
            int r6 = r14.f599l
            e.f.a.j.f r6 = r0.d(r6)
            ...
            r14.W = r7
            r3.W = r7
            e.f.a.j.e$d r3 = e.f.a.j.e.d.BASELINE
            e.f.a.j.e r18 = r13.h(r3)
            e.f.a.j.e$d r3 = e.f.a.j.e.d.BASELINE
            e.f.a.j.e r19 = r6.h(r3)
            r20 = 0
            r21 = -1
            e.f.a.j.e$c r22 = e.f.a.j.e.c.STRONG
            r23 = 0
            r24 = 1
            r18.a(r19, r20, r21, r22, r23, r24)
            e.f.a.j.e$d r3 = e.f.a.j.e.d.TOP
            e.f.a.j.e r3 = r13.h(r3)
            r3.m()
            e.f.a.j.e$d r3 = e.f.a.j.e.d.BOTTOM
            e.f.a.j.e r3 = r13.h(r3)
            r3.m()
        L_0x0312:
        ...
        L_0x0340:
            ...
            e.f.a.j.f$b r3 = e.f.a.j.f.b.MATCH_PARENT
            r13.g0(r3)
            e.f.a.j.e$d r3 = e.f.a.j.e.d.LEFT
            e.f.a.j.e r3 = r13.h(r3)
            int r6 = r14.leftMargin
            r3.f8560e = r6
            e.f.a.j.e$d r3 = e.f.a.j.e.d.RIGHT
            e.f.a.j.e r3 = r13.h(r3)
            int r6 = r14.rightMargin
            r3.f8560e = r6
            goto L_0x0376
        L_0x0362:
            e.f.a.j.f$b r3 = e.f.a.j.f.b.MATCH_CONSTRAINT
            r13.g0(r3)
            r3 = 0
            r13.y0(r3)
            goto L_0x0376
        L_0x036c:
            e.f.a.j.f$b r3 = e.f.a.j.f.b.FIXED
            r13.g0(r3)
            int r3 = r14.width
            r13.y0(r3)
        L_0x0376:
        ...
        L_0x03a3:
            r3 = 0
            e.f.a.j.f$b r6 = e.f.a.j.f.b.FIXED
            r13.u0(r6)
            int r6 = r14.height
            r13.b0(r6)
        L_0x03ae:
    ...
    private void l(int i2, int i3) {
        ...
        if (mode != Integer.MIN_VALUE) {
            if (mode == 0) {
                ...
                i4 = Math.min(this.f589m, size) - paddingLeft;
                bVar = bVar2;
            }
            i4 = 0;
        } else {
        ...
        if (mode2 != Integer.MIN_VALUE) {
            if (mode2 == 0) {
                ...
                size2 = Math.min(this.f590n, size2) - paddingTop;
            }
            size2 = 0;
        } else {
            bVar2 = f.b.WRAP_CONTENT;
        ...
        this.f586j.u0(bVar2);
        this.f586j.b0(size2);
        this.f586j.m0((this.f587k - getPaddingLeft()) - getPaddingRight());
        this.f586j.l0((this.f588l - getPaddingTop()) - getPaddingBottom());
    }
    ...
    private void o() {
        ...
        int size = this.f584h.size();
        if (size > 0) {
            for (int i3 = 0; i3 < size; i3++) {
                this.f584h.get(i3).d(this);
            }
        }
    }
        ...
        if (isInEditMode()) {
            ...
            for (int i2 = 0; i2 < childCount; i2++) {
                ...
                if (!(childAt.getVisibility() == 8 || (tag = childAt.getTag()) == null || !(tag instanceof String))) {
                    String[] split = ((String) tag).split(AndroidSdkMetrics.SEPARATOR);
                    if (split.length == 4) {
    ...
    public void onMeasure(int r24, int r25) {
        ...
        L_0x00ac:
            e.f.a.j.g r13 = r0.f586j
            e.f.a.j.f$b r15 = e.f.a.j.f.b.FIXED
            r13.g0(r15)
        L_0x00b3:
            e.f.a.j.g r13 = r0.f586j
            boolean r15 = r13.z0
            ...
            r13.b0(r11)
        L_0x00c2:
            e.f.a.j.g r11 = r0.f586j
            e.f.a.j.f$b r13 = e.f.a.j.f.b.FIXED
            r11.u0(r13)
        L_0x00c9:
            int r11 = r0.p
            r13 = 32
            ...
            e.f.a.j.g r3 = r0.f586j
            java.util.List<e.f.a.j.h> r3 = r3.w0
            r10 = 0
            e.f.a.j.a.i(r3, r10, r11)
        L_0x00ec:
            int r3 = r0.u
        ...
        L_0x011e:
            ...
            r0.m(r3)
        L_0x0129:
            java.util.ArrayList<e.f.a.j.f> r3 = r0.f585i
            int r3 = r3.size()
            ...
            e.f.a.j.g r6 = r0.f586j
            e.f.a.j.f$b r6 = r6.s()
            e.f.a.j.f$b r11 = e.f.a.j.f.b.WRAP_CONTENT
        ...
        L_0x0148:
            e.f.a.j.g r11 = r0.f586j
            e.f.a.j.f$b r11 = r11.B()
            e.f.a.j.f$b r13 = e.f.a.j.f.b.WRAP_CONTENT
        ...
        L_0x0172:
            ...
            java.util.ArrayList<e.f.a.j.f> r15 = r0.f585i
            java.lang.Object r15 = r15.get(r10)
            e.f.a.j.f r15 = (e.f.a.j.f) r15
        ...
        L_0x0221:
            ...
            int r1 = r15.y()
            e.f.a.j.e$d r9 = e.f.a.j.e.d.RIGHT
            e.f.a.j.e r9 = r15.h(r9)
            int r9 = r9.d()
            int r1 = r1 + r9
    ...
    public void onViewAdded(View view) {
        ...
        if (view instanceof a) {
            ...
            if (!this.f584h.contains(aVar2)) {
                this.f584h.add(aVar2);
            }
        }
        this.f583g.put(view.getId(), view);
        this.o = true;
    }
    ...
    public void onViewRemoved(View view) {
        ...
        this.f583g.remove(view.getId());
        f f2 = f(view);
        this.f586j.L0(f2);
        this.f584h.remove(view);
        this.f585i.remove(f2);
        this.o = true;
    }
    ...
    public static class a extends ViewGroup.MarginLayoutParams {
        ...
        private static class C0009a {
            ...
            static {
                ...
                a.append(f.ConstraintLayout_Layout_layout_constraintLeft_toRightOf, 9);
                a.append(f.ConstraintLayout_Layout_layout_constraintRight_toLeftOf, 10);
                a.append(f.ConstraintLayout_Layout_layout_constraintRight_toRightOf, 11);
                a.append(f.ConstraintLayout_Layout_layout_constraintTop_toTopOf, 12);
                a.append(f.ConstraintLayout_Layout_layout_constraintTop_toBottomOf, 13);
                a.append(f.ConstraintLayout_Layout_layout_constraintBottom_toTopOf, 14);
                a.append(f.ConstraintLayout_Layout_layout_constraintBottom_toBottomOf, 15);
                a.append(f.ConstraintLayout_Layout_layout_constraintBaseline_toBaselineOf, 16);
                a.append(f.ConstraintLayout_Layout_layout_constraintCircle, 2);
                a.append(f.ConstraintLayout_Layout_layout_constraintCircleRadius, 3);
                a.append(f.ConstraintLayout_Layout_layout_constraintCircleAngle, 4);
                a.append(f.ConstraintLayout_Layout_layout_editor_absoluteX, 49);
                a.append(f.ConstraintLayout_Layout_layout_editor_absoluteY, 50);
                a.append(f.ConstraintLayout_Layout_layout_constraintGuide_begin, 5);
                a.append(f.ConstraintLayout_Layout_layout_constraintGuide_end, 6);
                a.append(f.ConstraintLayout_Layout_layout_constraintGuide_percent, 7);
                a.append(f.ConstraintLayout_Layout_android_orientation, 1);
                a.append(f.ConstraintLayout_Layout_layout_constraintStart_toEndOf, 17);
                a.append(f.ConstraintLayout_Layout_layout_constraintStart_toStartOf, 18);
                a.append(f.ConstraintLayout_Layout_layout_constraintEnd_toStartOf, 19);
                a.append(f.ConstraintLayout_Layout_layout_constraintEnd_toEndOf, 20);
                a.append(f.ConstraintLayout_Layout_layout_goneMarginLeft, 21);
                a.append(f.ConstraintLayout_Layout_layout_goneMarginTop, 22);
                a.append(f.ConstraintLayout_Layout_layout_goneMarginRight, 23);
                a.append(f.ConstraintLayout_Layout_layout_goneMarginBottom, 24);
                a.append(f.ConstraintLayout_Layout_layout_goneMarginStart, 25);
                a.append(f.ConstraintLayout_Layout_layout_goneMarginEnd, 26);
                a.append(f.ConstraintLayout_Layout_layout_constraintHorizontal_bias, 29);
                a.append(f.ConstraintLayout_Layout_layout_constraintVertical_bias, 30);
                a.append(f.ConstraintLayout_Layout_layout_constraintDimensionRatio, 44);
                a.append(f.ConstraintLayout_Layout_layout_constraintHorizontal_weight, 45);
                a.append(f.ConstraintLayout_Layout_layout_constraintVertical_weight, 46);
                a.append(f.ConstraintLayout_Layout_layout_constraintHorizontal_chainStyle, 47);
                a.append(f.ConstraintLayout_Layout_layout_constraintVertical_chainStyle, 48);
                a.append(f.ConstraintLayout_Layout_layout_constrainedWidth, 27);
                a.append(f.ConstraintLayout_Layout_layout_constrainedHeight, 28);
                a.append(f.ConstraintLayout_Layout_layout_constraintWidth_default, 31);
                a.append(f.ConstraintLayout_Layout_layout_constraintHeight_default, 32);
                a.append(f.ConstraintLayout_Layout_layout_constraintWidth_min, 33);
                a.append(f.ConstraintLayout_Layout_layout_constraintWidth_max, 34);
                a.append(f.ConstraintLayout_Layout_layout_constraintWidth_percent, 35);
                a.append(f.ConstraintLayout_Layout_layout_constraintHeight_min, 36);
                a.append(f.ConstraintLayout_Layout_layout_constraintHeight_max, 37);
                a.append(f.ConstraintLayout_Layout_layout_constraintHeight_percent, 38);
                a.append(f.ConstraintLayout_Layout_layout_constraintLeft_creator, 39);
                a.append(f.ConstraintLayout_Layout_layout_constraintTop_creator, 40);
                a.append(f.ConstraintLayout_Layout_layout_constraintRight_creator, 41);
                a.append(f.ConstraintLayout_Layout_layout_constraintBottom_creator, 42);
                a.append(f.ConstraintLayout_Layout_layout_constraintBaseline_creator, 43);
            }
        }
        ...
        public a(Context context, AttributeSet attributeSet) {
            ...
            for (int i3 = 0; i3 < indexCount; i3++) {
                ...
                int i4 = C0009a.a.get(index);
                switch (i4) {
                    case 1:
                        this.R = obtainStyledAttributes.getInt(index, this.R);
                        break;
                    case 2:
                        int resourceId = obtainStyledAttributes.getResourceId(index, this.f600m);
                        this.f600m = resourceId;
                        if (resourceId != -1) {
                            break;
                        } else {
                            this.f600m = obtainStyledAttributes.getInt(index, -1);
                            break;
                        }
                    case 3:
                        this.f601n = obtainStyledAttributes.getDimensionPixelSize(index, this.f601n);
                        break;
                    case 4:
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        int resourceId2 = obtainStyledAttributes.getResourceId(index, this.f591d);
                        this.f591d = resourceId2;
                        if (resourceId2 != -1) {
                            break;
                        } else {
                            this.f591d = obtainStyledAttributes.getInt(index, -1);
                            break;
                        }
                    case 9:
                        int resourceId3 = obtainStyledAttributes.getResourceId(index, this.f592e);
                        this.f592e = resourceId3;
                        if (resourceId3 != -1) {
                            break;
                        } else {
                            this.f592e = obtainStyledAttributes.getInt(index, -1);
                            break;
                        }
                    case 10:
                        int resourceId4 = obtainStyledAttributes.getResourceId(index, this.f593f);
                        this.f593f = resourceId4;
                        if (resourceId4 != -1) {
                            break;
                        } else {
                            this.f593f = obtainStyledAttributes.getInt(index, -1);
                            break;
                        }
                    case 11:
                        int resourceId5 = obtainStyledAttributes.getResourceId(index, this.f594g);
                        this.f594g = resourceId5;
                        if (resourceId5 != -1) {
                            break;
                        } else {
                            this.f594g = obtainStyledAttributes.getInt(index, -1);
                            break;
                        }
                    case 12:
                        int resourceId6 = obtainStyledAttributes.getResourceId(index, this.f595h);
                        this.f595h = resourceId6;
                        if (resourceId6 != -1) {
                            break;
                        } else {
                            this.f595h = obtainStyledAttributes.getInt(index, -1);
                            break;
                        }
                    case 13:
                        int resourceId7 = obtainStyledAttributes.getResourceId(index, this.f596i);
                        this.f596i = resourceId7;
                        if (resourceId7 != -1) {
                            break;
                        } else {
                            this.f596i = obtainStyledAttributes.getInt(index, -1);
                            break;
                        }
                    case 14:
                        int resourceId8 = obtainStyledAttributes.getResourceId(index, this.f597j);
                        this.f597j = resourceId8;
                        if (resourceId8 != -1) {
                            break;
                        } else {
                            this.f597j = obtainStyledAttributes.getInt(index, -1);
                            break;
                        }
                    case 15:
                        int resourceId9 = obtainStyledAttributes.getResourceId(index, this.f598k);
                        this.f598k = resourceId9;
                        if (resourceId9 != -1) {
                            break;
                        } else {
                            this.f598k = obtainStyledAttributes.getInt(index, -1);
                            break;
                        }
                    case 16:
                        int resourceId10 = obtainStyledAttributes.getResourceId(index, this.f599l);
                        this.f599l = resourceId10;
                        if (resourceId10 != -1) {
                            break;
                        } else {
                            this.f599l = obtainStyledAttributes.getInt(index, -1);
                            break;
                        }
                    case 17:
